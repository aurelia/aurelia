...
If you are interested in contributing to Aurelia, please see our [contributor documentation](docs/user-docs/6.%20community-contributions/1.%20joining-the-community) for more information. You'll learn how to build the code and run tests, how best to engage in our social channels, how to submit PRs, and even how to contribute to our documentation. We welcome you and thank you in advance for joining with us in this endeavor.
