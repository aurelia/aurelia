...
Need practical recipes? Check the [state management outcome guide](../state-outcome-recipes.md) for optimistic updates, persistence, time-travel debugging, and more.

## Aurelia Store guides

Please visit one or more of the following sections to learn about the Aurelia Store plugin:

- [Configuration and setup](configuration-and-setup.md) — install the plugin and initialize your root state
- [Middleware](middleware.md) — extend the store with logging, persistence, and custom behaviors
