...
When it comes to testing, Aurelia provides a testing package, `@aurelia/testing`, comes with some helper functions, including a fixture creation method that allows you to instantiate components and handle setup and teardown.
...
If you are new to testing or inexperienced, it is worth noting that tests in Aurelia are broken down into three distinct categories.
