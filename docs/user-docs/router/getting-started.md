...
To use the `router`, we have to register it with Aurelia.
...
{% hint style="info" %}
To know more about the different configuration options for router, please refer the [documentation](./router-configuration.md) on that topic.
{% endhint %}
...
For the documentation of router, many live examples are prepared.
