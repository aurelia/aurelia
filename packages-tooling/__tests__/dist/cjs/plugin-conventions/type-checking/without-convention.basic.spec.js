...
`,
      ...
      @customElement({ name: 'foo', template })
      export class Foo {
      ${(0, _shared_1.prop)('prop', 'string | number', isTs)}
      }
      `,
                    readFile: (0, _shared_1.createMarkupReader)(markupFile, markup),
                }, exports.nonConventionalOptions);
          ...
          `,
                ...
                (0, _shared_1.assertFailure)(entry, result.code, [/Property 'toExponential' does not exist on type 'string \| number'/]);
            });
    ...
    `,
        ...
        `,
          ...
          @customElement({ name: 'foo', template })
          export class Foo {
          ${(0, _shared_1.prop)('bar', 'number | boolean', isTs)}
          ${isTs ? '' : `
          /**
          ...
          `,
                ...
                (0, _shared_1.assertFailure)(entry, result.code, [/Argument of type 'string' is not assignable to parameter of type 'number \| boolean'/]);
            });
        });
        describe(`method - language: ${lang}`, function () {
            it(`fail - not enough arguments`, function () {
                ...
                (0, _shared_1.assertFailure)(entry, result.code, [/Expected 2 arguments, but got 1/]);
            });
            it(`fail - too many arguments`, function () {
                ...
                (0, _shared_1.assertFailure)(entry, result.code, [/Expected 2 arguments, but got 3/]);
            });
            ...
            it(`overloaded method - fail`, function () {
                ...
                (0, _shared_1.assertFailure)(entry, result.code, [/Property 'toExponential' does not exist on type 'string'/, /Property 'toUpperCase' does not exist on type 'number'/]);
            });
        });
        describe('access modifier', function () {
            for (const accessModifier of ['public', 'protected', 'private']) {
...
@customElement({ name: 'foo', template })
export class Foo {
${(0, _shared_1.prop)('prop', 'string', isTs, accessModifier)}
}
`,
                        readFile: (0, _shared_1.createMarkupReader)(markupFile, markup),
                    }, exports.nonConventionalOptions);
...
`,
  ...
  `,
                        ...
                        (0, _shared_1.assertFailure)(entry, result.code, [/Argument of type 'number' is not assignable to parameter of type 'string'/]);
                    });
                });
            }
        });
