...
@customElement({ name: 'foo', template })
export class Foo {
${(0, _shared_1.prop)('people', '{ name: string }[]', isTs)}
}
`,
                readFile: (0, _shared_1.createMarkupReader)(markupFile, markup),
            }, without_convention_basic_spec_1.nonConventionalOptions);
...
`,
            ...
            (0, _shared_1.assertFailure)(entry, result.code, [/Property 'a' does not exist on type '.*Foo.*'/]);
        });
...
`,
            ...
            (0, _shared_1.assertFailure)(entry, result.code, [/Property 'z' does not exist on type '.*Foo.*'/]);
        });
    }
});
//# sourceMappingURL=without-convention.let.spec.js.map