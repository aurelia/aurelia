/* AUTO-GENERATED: 21_attr_preserve_aria_data
 * Do not edit by hand. Update with: npm run gen:ttc-goldens
 */

// === SOURCE ===
// HTML:
// <template><div aria-label="${firstName}" data-test="${lastName}"></div></template>
//
// CLASSES:
export {}
class Common {
...
function __au$access(_fn) { /* no-op */ }function __typecheck_template_Common__() {
  ...
  return `<template><div aria-label="${firstName}" data-test="${lastName}"></div></template>`;
}
