/* AUTO-GENERATED: 22_label_for_normalization
 * Do not edit by hand. Update with: npm run gen:ttc-goldens
 */

// === SOURCE ===
// HTML:
// <template><label for.bind="elementId">${firstName}</label></template>
//
// CLASSES:
export {}
class Common {
...
function __au$access(_fn) { /* no-op */ }function __typecheck_template_Common__() {
  ...
  return `<template><label for.bind="${access((/** @type {__AU_TTC_T0_F0} */(o)) => o.firstName, "elementId")}">${access((/** @type {__AU_TTC_T0_F0} */(o)) => o.elementId, "firstName")}</label></template>`;
}
