/* AUTO-GENERATED: 25_colon_bind_shorthand
 * Do not edit by hand. Update with: npm run gen:ttc-goldens
 */

// === SOURCE ===
// HTML:
// <template><input :value="firstName" :disabled="false" /></template>
//
// CLASSES:
export {}
class Common {
...
function __au$access(_fn) { /* no-op */ }function __typecheck_template_Common__() {
  ...
  return `<template><input :value="${access((/** @type {__AU_TTC_T0_F0} */(o)) => o.firstName, "firstName")}" :disabled="false" /></template>`;
}
