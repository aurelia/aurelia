/* AUTO-GENERATED: 29_contenteditable_conditional_two_way
 * Do not edit by hand. Update with: npm run gen:ttc-goldens
 */

// === SOURCE ===
// HTML:
// <template><div contenteditable="true" textcontent.bind="greeting"></div></template>
//
// CLASSES:
export {}
class Common {
...
function __au$access(_fn) { /* no-op */ }function __typecheck_template_Common__() {
  ...
  return `<template><div contenteditable="true" textcontent.bind="${access((/** @type {__AU_TTC_T0_F0} */(o)) => o.greeting, "greeting")}"></div></template>`;
}
