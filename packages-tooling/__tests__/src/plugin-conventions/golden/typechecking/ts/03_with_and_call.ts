...
function __typecheck_template_Common__(): string {
  ...
  return `<template><div with.bind="${access<__AU_TTC_T0_F1>(o => o.deep.v, "obj['key']")}">${access<__AU_TTC_T0_F0>(o => o.obj["key"], "deep.v")}<button click.trigger="${access<__AU_TTC_T0_F1>(o => o.doThing(1, "ok"), "doThing(1, 'ok')")}"></button></div></template>`;
}
