...
function __typecheck_template_Common__(): string {
  ...
  return `<template>
      <div with.bind="${access<__AU_TTC_T0_F1>(o => o, "deep")}">
        ${access<__AU_TTC_T0_F0>(o => o.deep, "v")} ${access<__AU_TTC_T0_F1>(o => o.v, "$parent.firstName")} ${access<__AU_TTC_T0_F1>(o => o.firstName, "this.firstName")}
      </div>
    </template>`;
}
