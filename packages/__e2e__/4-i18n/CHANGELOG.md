...
**Note:** Version bump only for package @aurelia/4-i18n
...
* **e2e:** try resolve e2e i18n flakiness ([48e3f40](https://github.com/aurelia/aurelia/commit/48e3f40))
* **e2e:** try resolve e2e i18n flakiness ([bed9e32](https://github.com/aurelia/aurelia/commit/bed9e32))
