...
describe('ExpressionParser', function () {
  ...
  describe('parse ForOfStatement', function () {
    ...
    const ForDeclarations: [string, any][] = [
      ...
      // [`[a,b=p1[0].p2,d,c=p3.p4[1]]`, new DAE(aknd, [dase(0, 'a'), dase(1, 'b', new AME(new AKE(new ASE('p1', 0), new PLE(0)), 'p2')), dase('d'), dase(2, 'c', new AKE(new AME(new ASE('p3', 0), 'p4'), new PLE(1)))], void 0)],
