...
describe('2-runtime/ast.optional.spec.ts', function () {
    describe('non-strict mode', function () {
        ...
        describe('assignment', function () {
            let MyEl = (() => {
                let _classDecorators = [customElement({ name: 'my-el', template: '', bindables: [{ name: 'value', mode: 'fromView' }] })];
            ...
            it('assigns on access member assignment - missing scope', function () {
                const { component } = createFixture('<my-el value.from-view="a.b" component.ref="el">', class App {
                    constructor() {
            ...
            it('throws on access keyed assignment - missing scope', function () {
                const { trigger, component } = createFixture('<button click.trigger="a[5] = 1">', class {
                });
    ...
    describe('strict mode', function () {
        const createStrictFixture = (template, component, registrations = []) => createFixture
            .html(template)
            .deps(...registrations)
        ...
        describe('assignment', function () {
            ...
            it('throws on access member assignment - missing scope', function () {
                const { component } = createStrictFixture('<my-el value.from-view="a.b" component.ref="el">', class App {
                    constructor() {
                        // starts with an empty object to avoid error
                        this.a = {};
                    }
    ...
    function handleAuEventError(platform, handler) {
        platform.window.addEventListener('au-event-error', function auEventErrorHandler(e) {
            e.preventDefault();
            handler(e);
