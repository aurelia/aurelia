...
describe('3-runtime-html/custom-elements.syntax.spec.ts', function () {
    it('keeps underscore in the middle of attribute names', async function () {
        const { assertText } = createFixture(`<my-el my_prop.bind="message">`, class App {
            constructor() {
    ...
    it('keeps trailing underscore of attribute names', async function () {
        const { assertText } = createFixture(`<my-el _my_prop_.bind="message">`, class App {
            constructor() {
                this.message = 'Hello Aurelia 2!';
            }
        }, [
...
//# sourceMappingURL=custom-elements.syntax.spec.js.map