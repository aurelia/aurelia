...
import { RouteExpression, CompositeSegmentExpression, ScopedSegmentExpression, SegmentGroupExpression, SegmentExpression, ComponentExpression, ViewportExpression, ParameterListExpression, ParameterExpression, NavigationOptions, RouterOptions, pathUrlParser, } from '@aurelia/router';
const terminal = ['?', '#', '/', '+', '(', ')', '@', '!', '=', ',', '&', '\'', '~', ';'];
