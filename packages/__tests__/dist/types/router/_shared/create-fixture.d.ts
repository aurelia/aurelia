 ...
 */
export declare function start<TAppRoot>({ appRoot, useHash, registrations, historyStrategy, activeClass, treatQueryAsParameters }: RouterTestStartOptions<TAppRoot>): Promise<{
    host: HTMLDivElement;
    au: Aurelia;
    container: IContainer;
    rootVm: TAppRoot;
