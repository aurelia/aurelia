...
/** @param {import('karma').Config & { browsers?: string[]; coverage?: any; }} config */ function (config) {
  ...
  const circleCiFiles = [
    ...
    'packages/__tests__/dist/1-kernel/logger.spec.js',
    'packages/__tests__/dist/2-runtime/array-observer.spec.js',
    'packages/__tests__/dist/2-runtime/binding-behavior.spec.js',
    'packages/__tests__/dist/2-runtime/connectable-switcher.spec.js',
    'packages/__tests__/dist/2-runtime/property-observation.spec.js',
    'packages/__tests__/dist/2-runtime/value-converter.spec.js',
    'packages/__tests__/dist/3-runtime-html/arrow-fn.spec.js',
    'packages/__tests__/dist/3-runtime-html/au-slot.slotted.spec.js',
    'packages/__tests__/dist/3-runtime-html/binding-behavior.spec.js',
    'packages/__tests__/dist/3-runtime-html/binding-command.class.spec.js',
    'packages/__tests__/dist/3-runtime-html/checked-observer.spec.js',
    'packages/__tests__/dist/3-runtime-html/containerless.spec.js',
    'packages/__tests__/dist/3-runtime-html/custom-attributes.spec.js',
    'packages/__tests__/dist/3-runtime-html/custom-elements.let.spec.js',
    'packages/__tests__/dist/3-runtime-html/decorator-watch.expression.spec.js',
    'packages/__tests__/dist/3-runtime-html/dom.spec.js',
    'packages/__tests__/dist/3-runtime-html/focus.spec.js',
    'packages/__tests__/dist/3-runtime-html/generated/static.if-else.spec.js',
    'packages/__tests__/dist/3-runtime-html/input.spec.js',
    'packages/__tests__/dist/3-runtime-html/lifecycle-hooks.attached.spec.js',
    'packages/__tests__/dist/3-runtime-html/lifecycle-hooks.created.spec.js',
    'packages/__tests__/dist/3-runtime-html/lifecycle-hooks.resolve.spec.js',
    'packages/__tests__/dist/3-runtime-html/observer-locator.spec.js',
    'packages/__tests__/dist/3-runtime-html/promise.spec.js',
    'packages/__tests__/dist/3-runtime-html/repeat.custom-repeatable.spec.js',
    'packages/__tests__/dist/3-runtime-html/repeat.keyed.set.spec.js',
    'packages/__tests__/dist/3-runtime-html/repeater-if-else.spec.js',
    'packages/__tests__/dist/3-runtime-html/repeater.unit.spec.js',
    'packages/__tests__/dist/3-runtime-html/show.integration.spec.js',
    'packages/__tests__/dist/3-runtime-html/styles.spec.js',
    'packages/__tests__/dist/3-runtime-html/template-compiler.au-slot.spec.js',
    'packages/__tests__/dist/3-runtime-html/template-compiler.local-templates.spec.js',
  ...
  const files = [
    ...
    { type: 'module', watched: false,           included: false, nocache: false,  pattern: `node_modules/rxjs/dist/esm/**/*.js` }, // 3.1
    { type: 'module', watched: false,           included: false, nocache: false,  pattern: `node_modules/rxjs/dist/esm/**/*.js.map` }, // 3.1
    { type: 'module', watched: false,           included: false, nocache: false,  pattern: `node_modules/rxjs/dist/esm/**/*.d.ts` }, // 3.1
...
function prepareIndexMap() {
  ...
  return {
    ...
    ...fs.readdirSync(path.resolve('../../node_modules/rxjs/dist/esm/internal/')).reduce((map, file) => {
      if (!file.endsWith('.js')) {
        return map;
      }
      const name = file.replace(/\.js$/, '');
      map[`rxjs/dist/esm/internal/${name}`]
        ...
        = map[`/base/node_modules/rxjs/dist/esm/internal/${name}`]
        = `/base/node_modules/rxjs/dist/esm/internal/${file}`;
      return map;
    }, {}),
    ...['observable', 'observable/dom', 'operators', 'scheduled', 'scheduler', 'symbol', 'testing', 'util'].reduce((map, name) => {
      const modules = fs.readdirSync(path.resolve(`../../node_modules/rxjs/dist/esm/internal/${name}/`));
      modules.forEach(moduleName => {
        if (!moduleName.endsWith('.js')) return;
        const basename = moduleName.replace(/\.js$/, '');

        map[`rxjs/dist/esm/internal/${name}/${basename}`]
          // sometimes, there's relative import from within the others modules
          // that will end up requesting the path that looks like this
          = map[`/base/node_modules/rxjs/dist/esm/internal/${name}/${basename}`]
          = `/base/node_modules/rxjs/dist/esm/internal/${name}/${moduleName}`;
      });
      return map;
    }, {
      'rxjs': '/base/node_modules/rxjs/dist/esm/index.js',
      'rxjs/operators': '/base/node_modules/rxjs/dist/esm/operators/index.js',
    }),
  };
}
