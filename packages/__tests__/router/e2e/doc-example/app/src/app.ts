// import { RouteTable } from './../../../../../../router/src/route-table';
...
@inject(IRouter, INode, AuthorsRepository, State)
@customElement({
  name: 'app', template:
    `
<div class="info">
...
export class App {
  ...
  public constructor(private readonly router: IRouter, private readonly element: Element, authorsRepository: AuthorsRepository, private readonly state: State) {
