...
export class $AsyncFunctionConstructor extends $BuiltinFunction {
...
export class $AsyncFunctionPrototype extends $Object {
...
export function $AsyncFunctionStart(ctx, promiseCapability, asyncFunctionBody) {
    ...
    asyncContext.onResume = function (resumptionValue) {
        ...
        // 3. f. Else,
            ...
            $Call(asyncContext, promiseCapability['[[Reject]]'], intrinsics.undefined, new $List(result)); // TODO: is this cast safe?
        }
        // 3. g. Return.
