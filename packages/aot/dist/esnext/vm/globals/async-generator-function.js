...
export class $AsyncGeneratorFunctionConstructor extends $BuiltinFunction {
...
export class $AsyncGeneratorFunctionPrototype extends $Object {
...
export class $AsyncGeneratorPrototype extends $Object {
...
export class $AsyncGeneratorPrototype_next extends $BuiltinFunction {
...
export class $AsyncGeneratorPrototype_return extends $BuiltinFunction {
    constructor(realm, proto) {
...
export class $AsyncGeneratorPrototype_throw extends $BuiltinFunction {
    constructor(realm, proto) {
...
export var AsyncGeneratorState;
...
export class $AsyncGeneratorInstance extends $Object {
    constructor(realm, proto) {
        const intrinsics = realm['[[Intrinsics]]'];
...
export function $AsyncGeneratorStart(ctx, generator, generatorBody) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
...
export function $AsyncGeneratorResolve(ctx, generator, value, done) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    // 1. Assert: generator is an AsyncGenerator instance.
...
export function $AsyncGeneratorReject(ctx, generator, exception) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    // 1. Assert: generator is an AsyncGenerator instance.
    // 2. Let queue be generator.[[AsyncGeneratorQueue]].
...
export function $AsyncGeneratorResumeNext(ctx, generator) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    const stack = realm.stack;
    // 1. Assert: generator is an AsyncGenerator instance.
...
export class $AsyncGeneratorResumeNext_Return_Processor_Fulfilled extends $BuiltinFunction {
...
export class $AsyncGeneratorResumeNext_Return_Processor_Rejected extends $BuiltinFunction {
    constructor(realm, generator) {
        const intrinsics = realm['[[Intrinsics]]'];
...
export function $AsyncGeneratorEnqueue(ctx, generator, completion) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
...
export function $AsyncGeneratorYield(ctx, value) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
    const stack = realm.stack;
