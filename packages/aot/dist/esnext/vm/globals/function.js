...
export class $FunctionPrototype extends $Object {
...
export class $FunctionPrototype_apply extends $BuiltinFunction {
...
export class $FunctionPrototype_bind extends $BuiltinFunction {
    constructor(realm, proto) {
...
export class $FunctionPrototype_call extends $BuiltinFunction {
    constructor(realm, proto) {
...
export class $FunctionPrototype_hasInstance extends $BuiltinFunction {
    constructor(realm, proto) {
...
export function $CreateDynamicFunction(ctx, constructor, newTarget, kind, args) {
    const realm = ctx.Realm;
    const intrinsics = realm['[[Intrinsics]]'];
