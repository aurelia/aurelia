...
import { $IteratorPrototype, $AsyncIteratorPrototype, $AsyncFromSyncIteratorPrototype, $AsyncFromSyncIteratorPrototype_next, $AsyncFromSyncIteratorPrototype_return, $AsyncFromSyncIteratorPrototype_throw, } from './globals/iteration';
...
import { $FunctionPrototype, $FunctionConstructor, $FunctionPrototype_call, $FunctionPrototype_apply, $FunctionPrototype_bind, $FunctionPrototype_toString, $FunctionPrototype_hasInstance, } from './globals/function';
...
import { $ErrorConstructor, $ErrorPrototype, $ErrorPrototype_toString, $EvalErrorConstructor, $EvalErrorPrototype, $RangeErrorConstructor, $RangeErrorPrototype, $ReferenceErrorConstructor, $ReferenceErrorPrototype, $SyntaxErrorConstructor, $SyntaxErrorPrototype, $TypeErrorConstructor, $TypeErrorPrototype, $URIErrorConstructor, $URIErrorPrototype, } from './globals/error';
import { $ThrowTypeError, } from './globals/throw-type-error';
import { $GeneratorFunctionPrototype, $GeneratorPrototype, $GeneratorFunctionConstructor, $GeneratorPrototype_next, $GeneratorPrototype_return, $GeneratorPrototype_throw, } from './globals/generator-function';
import { $PromiseConstructor, $PromisePrototype, $Promise_all, $Promise_race, $Promise_resolve, $Promise_reject, $PromiseProto_then, $PromiseProto_catch, $PromiseProto_finally, } from './globals/promise';
...
import { $ProxyConstructor, $Proxy_revocable, } from './globals/proxy';
import { $Reflect, $Reflect_apply, $Reflect_construct, $Reflect_defineProperty, $Reflect_deleteProperty, $Reflect_get, $Reflect_getOwnPropertyDescriptor, $Reflect_getPrototypeOf, $Reflect_has, $Reflect_isExtensible, $Reflect_ownKeys, $Reflect_preventExtensions, $Reflect_set, $Reflect_setPrototypeOf, } from './globals/reflect';
