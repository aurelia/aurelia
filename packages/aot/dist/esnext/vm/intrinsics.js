...
import { $IteratorPrototype, $AsyncIteratorPrototype, $AsyncFromSyncIteratorPrototype, $AsyncFromSyncIteratorPrototype_next, $AsyncFromSyncIteratorPrototype_return, $AsyncFromSyncIteratorPrototype_throw, } from './globals/iteration.js';
import { $StringConstructor, $StringPrototype, } from './globals/string.js';
import { $ObjectConstructor, $ObjectPrototype, $ObjProto_toString, $ObjProto_valueOf, $ObjectPrototype_hasOwnProperty, $ObjectPrototype_isPrototypeOf, $ObjectPrototype_propertyIsEnumerable, $ObjectPrototype_toLocaleString, $Object_assign, $Object_create, $Object_defineProperties, $Object_defineProperty, $Object_entries, $Object_freeze, $Object_fromEntries, $Object_getOwnPropertyDescriptor, $Object_getOwnPropertyDescriptors, $Object_getOwnPropertyNames, $Object_getOwnPropertySymbols, $Object_getPrototypeOf, $Object_is, $Object_isExtensible, $Object_isFrozen, $Object_isSealed, $Object_keys, $Object_preventExtensions, $Object_seal, $Object_setPrototypeOf, $Object_values, } from './globals/object.js';
import { $FunctionPrototype, $FunctionConstructor, $FunctionPrototype_call, $FunctionPrototype_apply, $FunctionPrototype_bind, $FunctionPrototype_toString, $FunctionPrototype_hasInstance, } from './globals/function.js';
...
import { $ErrorConstructor, $ErrorPrototype, $ErrorPrototype_toString, $EvalErrorConstructor, $EvalErrorPrototype, $RangeErrorConstructor, $RangeErrorPrototype, $ReferenceErrorConstructor, $ReferenceErrorPrototype, $SyntaxErrorConstructor, $SyntaxErrorPrototype, $TypeErrorConstructor, $TypeErrorPrototype, $URIErrorConstructor, $URIErrorPrototype, } from './globals/error.js';
import { $ThrowTypeError, } from './globals/throw-type-error.js';
import { $GeneratorFunctionPrototype, $GeneratorPrototype, $GeneratorFunctionConstructor, $GeneratorPrototype_next, $GeneratorPrototype_return, $GeneratorPrototype_throw, } from './globals/generator-function.js';
import { $PromiseConstructor, $PromisePrototype, $Promise_all, $Promise_race, $Promise_resolve, $Promise_reject, $PromiseProto_then, $PromiseProto_catch, $PromiseProto_finally, } from './globals/promise.js';
import { $GetSpecies, } from './globals/_shared.js';
import { $AsyncFunctionPrototype, $AsyncFunctionConstructor, } from './globals/async-function.js';
import { $AsyncGeneratorFunctionPrototype, $AsyncGeneratorFunctionConstructor, $AsyncGeneratorPrototype, $AsyncGeneratorPrototype_next, $AsyncGeneratorPrototype_return, $AsyncGeneratorPrototype_throw, } from './globals/async-generator-function.js';
import { $ProxyConstructor, $Proxy_revocable, } from './globals/proxy.js';
import { $Reflect, $Reflect_apply, $Reflect_construct, $Reflect_defineProperty, $Reflect_deleteProperty, $Reflect_get, $Reflect_getOwnPropertyDescriptor, $Reflect_getPrototypeOf, $Reflect_has, $Reflect_isExtensible, $Reflect_ownKeys, $Reflect_preventExtensions, $Reflect_set, $Reflect_setPrototypeOf, } from './globals/reflect.js';
