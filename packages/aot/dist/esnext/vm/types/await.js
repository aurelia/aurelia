...
export function $Await(ctx, value) {
    ...
    const promise = $PromiseResolve(ctx, intrinsics['%Promise%'], new $List(value)); // TODO: this cast urgently needs to be addressed with corrected typings
    if (promise.isAbrupt) {
        return promise;
    }
...
export class $Await_Fulfilled extends $BuiltinFunction {
...
export class $Await_Rejected extends $BuiltinFunction {
    constructor(realm, asyncContext) {
        const intrinsics = realm['[[Intrinsics]]'];
