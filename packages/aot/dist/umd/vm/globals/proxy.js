(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../types/function", "../types/error", "../types/object", "../exotics/proxy", "../operations", "../types/string"], factory);
    }
    ...
    const proxy_1 = require("../exotics/proxy");
    ...
    class $ProxyConstructor extends function_1.$BuiltinFunction {
        ...
        performSteps(ctx, thisArgument, [target, handler], NewTarget) {
            ...
            if (NewTarget.isUndefined) {
                return new error_1.$TypeError(realm, `Proxy cannot be called as a function`);
            }
            // 2. Return ? ProxyCreate(target, handler).
            return new proxy_1.$ProxyExoticObject(realm, target, handler);
        }
    }
    exports.$ProxyConstructor = $ProxyConstructor;
    // http://www.ecma-international.org/ecma-262/#sec-proxy.revocable
    // 26.2.2.1 Proxy.revocable ( target , handler )
    class $Proxy_revocable extends function_1.$BuiltinFunction {
        constructor(realm, functionPrototype) {
        ...
        performSteps(ctx, thisArgument, [target, handler], NewTarget) {
            ...
            const p = new proxy_1.$ProxyExoticObject(realm, target, handler);
            if (p.isAbrupt) {
                return p;
            }
            ...
            const result = object_1.$Object.ObjectCreate(ctx, 'Revocable Proxy', intrinsics['%ObjectPrototype%']);
            // 6. Perform CreateDataProperty(result, "proxy", p).
            operations_1.$CreateDataProperty(ctx, result, new string_1.$String(realm, 'proxy'), p);
            // 7. Perform CreateDataProperty(result, "revoke", revoker).
            operations_1.$CreateDataProperty(ctx, result, new string_1.$String(realm, 'revoke'), revoker);
            // 8. Return result.
            return result;
        }
    }
    ...
    class $Proxy_revocation extends function_1.$BuiltinFunction {
