...
import { $Any, CompletionType, $AnyNonEmpty, $PropertyKey, $AnyObject, $AnyNonError } from './types/_shared';
...
function IsConstructor(ctx: ExecutionContext, argument: $AnyNonEmpty): argument is $Function {
