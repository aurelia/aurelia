...
export { AppTask, AuSlotsInfo, Bindable, BindingBehavior, BindingMode, ComputedObserver, ComputedWatcher, Controller, CustomAttribute, CustomElement, ExpressionWatcher, IAppRoot, IAttrSyntaxTransformer, IAttributePattern, IAuSlotsInfo, IAurelia, IEventTarget, ILifecycleHooks, INode, IObserverLocator, IPlatform, IRenderLocation, ISignaler, IWorkTracker, LifecycleFlags, LifecycleHooks, NodeObserverLocator, ShortHandBindingSyntax, StyleConfiguration, TaskQueuePriority, ValueConverter, ViewFactory, Watch, alias, attributePattern, bindable, bindingBehavior, bindingCommand, children, containerless, createElement, cssModules, customAttribute, customElement, getTarget, lifecycleHooks, registerAliases, renderer, shadowCSS, subscriberCollection, templateController, useShadowDOM, valueConverter, watch } from '@aurelia/runtime-html';
