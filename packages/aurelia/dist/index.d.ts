...
export { computed, IObserverLocator, ISignaler, subscriberCollection, collectionSubscriberCollection, proxySubscriberCollection, bindingBehavior, BindingBehavior, BindingBehaviorInstance, customAttribute, CustomAttribute, templateController, containerless, customElement, CustomElementHost, CustomElement, useShadowDOM, ValueConverter, ValueConverterInstance, valueConverter, TaskQueuePriority, bindable, Bindable, children, Controller, ViewFactory, IAppRoot, alias, registerAliases, INode, IEventTarget, IRenderLocation, BindingMode, BindingStrategy, LifecycleFlags, ILifecycle, IViewModel, IndexMap, instructionComposer, IAurelia, attributePattern, IAttributePattern, bindingCommand, BindingCommandInstance, getTarget, ShortHandBindingSyntax, createElement, StyleConfiguration, IShadowDOMConfiguration, cssModules, shadowCSS, } from '@aurelia/runtime-html';
