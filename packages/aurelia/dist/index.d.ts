...
export { all, DI, IContainer, inject, IRegistration, IRegistry, IResolver, IServiceLocator, Key, lazy, optional, Registration, singleton, transient, InstanceProvider, Resolved, Class, Constructable, ConstructableClass, ICallable, IDisposable, IIndexable, Metadata, ColorOptions, ILogger, LoggerConfiguration, PLATFORM, Reporter, Tracer, LogLevel, Profiler, EventAggregator, EventAggregatorCallback, IEventAggregator, isNumeric, camelCase, kebabCase, pascalCase, toArray, bound, } from '@aurelia/kernel';
