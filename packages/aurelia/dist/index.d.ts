...
export { ComputedObserver, ComputedWatcher, ExpressionWatcher, IObserverLocator, ISignaler, subscriberCollection, collectionSubscriberCollection, bindingBehavior, BindingBehavior, BindingBehaviorInstance, customAttribute, CustomAttribute, templateController, containerless, customElement, CustomElement, useShadowDOM, ValueConverter, ValueConverterInstance, valueConverter, TaskQueuePriority, bindable, Bindable, children, Controller, ViewFactory, IAppRoot, alias, registerAliases, INode, IEventTarget, IRenderLocation, BindingMode, LifecycleFlags, ILifecycle, IViewModel, IndexMap, renderer, IAurelia, attributePattern, IAttributePattern, bindingCommand, BindingCommandInstance, getTarget, ShortHandBindingSyntax, createElement, StyleConfiguration, IShadowDOMConfiguration, cssModules, shadowCSS, } from '@aurelia/runtime-html';
