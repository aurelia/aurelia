...
declare const canInstrument: true, getCacheKey: (fileData: string, filePath: string, configStr: string, options: CacheKeyOptions) => string, process: (sourceText: string, sourcePath: string, config: Config.ProjectConfig, transformOptions?: TransformOptions | undefined) => TransformedSource;
