...
function y(n) {
    ...
    return {
        register(i) {
            return i.register(t.Registration.callback(l, (() => n.initOptions)), s.AppTask.beforeActivate(f, (t => t.initPromise)), t.Registration.singleton(u, I18nextWrapper), t.Registration.singleton(f, exports.I18nService), ...c, ...w);
        }
    };
}
