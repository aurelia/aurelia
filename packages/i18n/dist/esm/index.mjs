...
import { AttributePattern as v, AttrSyntax as B, BindingCommand as T } from "@aurelia/template-compiler";

import { ValueConverterExpression as b, CustomExpression as C } from "@aurelia/expression-parser";
