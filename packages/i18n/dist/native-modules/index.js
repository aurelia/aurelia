...
function at(t) {
    ...
    return {
        register(n) {
            return n.register(e.callback(V, (() => t.initOptions)), w.beforeActivate(_, (t => t.initPromise)), e.singleton($, I18nextWrapper), e.singleton(_, D), ...l, ...ot);
        }
    };
}
