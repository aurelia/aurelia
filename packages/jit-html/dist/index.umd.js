(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@aurelia/jit'), require('@aurelia/runtime-html'), require('@aurelia/kernel'), require('@aurelia/runtime')) :
    typeof define === 'function' && define.amd ? define(['exports', '@aurelia/jit', '@aurelia/runtime-html', '@aurelia/kernel', '@aurelia/runtime'], factory) :
    (global = global || self, factory(global.jitHtml = {}, global.jit, global.runtimeHtml, global.kernel, global.runtime));
}(this, function (exports, jit, runtimeHtml, kernel, runtime) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const ITemplateElementFactory = kernel.DI.createInterface().noDefault();
    /**
     * Default implementation for `ITemplateFactory` for use in an HTML based runtime.
     *
     * @internal
     */
    exports.HTMLTemplateElementFactory = class HTMLTemplateElementFactory {
        constructor(dom) {
            this.dom = dom;
    ...
    exports.HTMLTemplateElementFactory = __decorate([
        kernel.inject(runtime.IDOM)
    ], exports.HTMLTemplateElementFactory);
    ...
    exports.TemplateCompiler = __decorate([
        kernel.inject(ITemplateElementFactory, jit.IAttributeParser, runtime.IExpressionParser)
    ...
    const HTMLJitConfiguration = {
        register(container) {
            container.register(runtimeHtml.HTMLRuntimeConfiguration, jit.JitConfiguration, kernel.Registration.singleton(runtime.ITemplateCompiler, exports.TemplateCompiler), kernel.Registration.singleton(ITemplateElementFactory, exports.HTMLTemplateElementFactory), ...HTMLBindingLanguage);
        },
        createContainer() {
