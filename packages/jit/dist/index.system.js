System.register('jit', ['@aurelia/kernel', '@aurelia/runtime'], function (exports, module) {
  ...
  return {
    ...
    execute: function () {
      ...
      const ParserRegistration = exports('ParserRegistration', {
          register(container) {
      ...
      const JitConfiguration = exports('JitConfiguration', {
          register(container) {
