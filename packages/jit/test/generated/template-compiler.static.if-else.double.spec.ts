...
describe("generated.template-compiler.static.if-else.double", function generated_template_compiler_static_if_else_double() {
    ...
    it("tag$01 text$01 if$01 if$01 double$01 _", function tag$01_text$01_if$01_if$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 double$02 _", function tag$01_text$01_if$01_if$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 double$03 _", function tag$01_text$01_if$01_if$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 nested$01 double$01 _", function tag$01_text$01_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 nested$01 double$02 _", function tag$01_text$01_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 nested$01 double$03 _", function tag$01_text$01_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 nested$01 double$04 _", function tag$01_text$01_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$01 nested$01 double$05 _", function tag$01_text$01_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$02 double$01 _", function tag$01_text$01_if$01_if$02_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else>b</div><div if.bind=\"true\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$02 double$02 _", function tag$01_text$01_if$01_if$02_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else></div><div if.bind=\"true\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$02 double$03 _", function tag$01_text$01_if$01_if$02_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else>b</div><div if.bind=\"true\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$03 nested$01 double$01 _", function tag$01_text$01_if$01_if$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else>b</div></div><div if.bind=\"true\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$03 nested$01 double$01 _", function tag$01_text$01_if$01_if$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else>b</div></div><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$03 nested$01 double$02 _", function tag$01_text$01_if$01_if$03_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else></div></div><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$03 nested$01 double$03 _", function tag$01_text$01_if$01_if$03_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else>b</div></div><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$04 double$01 _", function tag$01_text$01_if$01_if$04_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">a</div><div else>b</div><div if.bind=\"true\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$04 double$02 _", function tag$01_text$01_if$01_if$04_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else></div><div if.bind=\"true\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$04 double$03 _", function tag$01_text$01_if$01_if$04_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">a</div><div else>b</div><div if.bind=\"true\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$05 nested$01 double$01 _", function tag$01_text$01_if$01_if$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div><div else>b</div></div><div else><div if.bind=\"true\">a</div><div else>b</div></div><div if.bind=\"true\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$05 nested$01 double$01 _", function tag$01_text$01_if$01_if$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div><div else>b</div></div><div else><div if.bind=\"true\">a</div><div else>b</div></div><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$05 nested$01 double$02 _", function tag$01_text$01_if$01_if$05_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else><div if.bind=\"true\"></div><div else></div></div><div if.bind=\"true\"><div if.bind=\"true\">a</div><div else>b</div></div><div else><div if.bind=\"true\">a</div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$05 nested$01 double$03 _", function tag$01_text$01_if$01_if$05_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div><div else>b</div></div><div else><div if.bind=\"true\">a</div><div else>b</div></div><div if.bind=\"true\"><div if.bind=\"true\">a</div><div else>b</div></div><div else><div if.bind=\"true\">a</div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$06 sibling$01 _", function tag$01_text$01_if$01_if$06_sibling$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$01 if$06 sibling$02 _", function tag$01_text$01_if$01_if$06_sibling$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else if.bind=\"true\"></div><div if.bind=\"true\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$06 sibling$03 _", function tag$01_text$01_if$01_if$06_sibling$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div else if.bind=\"true\">b</div><div if.bind=\"true\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$01 if$06 sibling$04 _", function tag$01_text$01_if$01_if$06_sibling$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">a</div><div else if.bind=\"true\">b</div><div else if.bind=\"true\">a</div><div if.bind=\"true\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$01 double$01 _", function tag$01_text$01_if$02_else$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 double$02 _", function tag$01_text$01_if$02_else$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 double$03 _", function tag$01_text$01_if$02_else$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 nested$01 double$01 _", function tag$01_text$01_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 nested$01 double$02 _", function tag$01_text$01_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 nested$01 double$03 _", function tag$01_text$01_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 nested$01 double$04 _", function tag$01_text$01_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$01 nested$01 double$05 _", function tag$01_text$01_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$02 double$01 _", function tag$01_text$01_if$02_else$02_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else>b</div><div if.bind=\"false\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$02 double$02 _", function tag$01_text$01_if$02_else$02_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else></div><div if.bind=\"false\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$02 double$03 _", function tag$01_text$01_if$02_else$02_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else>b</div><div if.bind=\"false\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$03 nested$01 double$01 _", function tag$01_text$01_if$02_else$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else>b</div></div><div if.bind=\"false\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$03 nested$01 double$01 _", function tag$01_text$01_if$02_else$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else>b</div></div><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$03 nested$01 double$02 _", function tag$01_text$01_if$02_else$03_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else></div></div><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$03 nested$01 double$03 _", function tag$01_text$01_if$02_else$03_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else>b</div></div><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$04 double$01 _", function tag$01_text$01_if$02_else$04_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">a</div><div else>b</div><div if.bind=\"false\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$04 double$02 _", function tag$01_text$01_if$02_else$04_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else></div><div if.bind=\"false\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$04 double$03 _", function tag$01_text$01_if$02_else$04_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">a</div><div else>b</div><div if.bind=\"false\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$05 nested$01 double$01 _", function tag$01_text$01_if$02_else$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div><div else>b</div></div><div else><div if.bind=\"false\">a</div><div else>b</div></div><div if.bind=\"false\"></div><div else></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$05 nested$01 double$01 _", function tag$01_text$01_if$02_else$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div><div else>b</div></div><div else><div if.bind=\"false\">a</div><div else>b</div></div><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$05 nested$01 double$02 _", function tag$01_text$01_if$02_else$05_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else><div if.bind=\"false\"></div><div else></div></div><div if.bind=\"false\"><div if.bind=\"false\">a</div><div else>b</div></div><div else><div if.bind=\"false\">a</div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$05 nested$01 double$03 _", function tag$01_text$01_if$02_else$05_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div><div else>b</div></div><div else><div if.bind=\"false\">a</div><div else>b</div></div><div if.bind=\"false\"><div if.bind=\"false\">a</div><div else>b</div></div><div else><div if.bind=\"false\">a</div><div else>b</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$06 sibling$01 _", function tag$01_text$01_if$02_else$06_sibling$01__() {
        const { au, host } = setup();
    ...
    it("tag$01 text$01 if$02 else$06 sibling$02 _", function tag$01_text$01_if$02_else$06_sibling$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else if.bind=\"false\"></div><div if.bind=\"false\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$06 sibling$03 _", function tag$01_text$01_if$02_else$06_sibling$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div else if.bind=\"false\">b</div><div if.bind=\"false\">a</div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$01 if$02 else$06 sibling$04 _", function tag$01_text$01_if$02_else$06_sibling$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">a</div><div else if.bind=\"false\">b</div><div else if.bind=\"false\">a</div><div if.bind=\"false\"></div><div else>b</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$01 text$02 if$01 if$01 double$01 _", function tag$01_text$02_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">a</div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 double$02 _", function tag$01_text$02_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\">a</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 double$03 _", function tag$01_text$02_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">a</div><div if.bind=\"true\">a</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 nested$01 double$01 _", function tag$01_text$02_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div></div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 nested$01 double$02 _", function tag$01_text$02_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div></div><div if.bind=\"true\"><div if.bind=\"true\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 nested$01 double$03 _", function tag$01_text$02_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\"><div if.bind=\"true\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 nested$01 double$04 _", function tag$01_text$02_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\"></div></div><div if.bind=\"true\"><div if.bind=\"true\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$01 if$01 nested$01 double$05 _", function tag$01_text$02_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">a</div></div><div if.bind=\"true\"><div if.bind=\"true\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 double$01 _", function tag$01_text$02_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">a</div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 double$02 _", function tag$01_text$02_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\">a</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 double$03 _", function tag$01_text$02_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">a</div><div if.bind=\"false\">a</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 nested$01 double$01 _", function tag$01_text$02_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div></div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 nested$01 double$02 _", function tag$01_text$02_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div></div><div if.bind=\"false\"><div if.bind=\"false\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 nested$01 double$03 _", function tag$01_text$02_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\"><div if.bind=\"false\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 nested$01 double$04 _", function tag$01_text$02_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\"></div></div><div if.bind=\"false\"><div if.bind=\"false\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$02 if$02 else$01 nested$01 double$05 _", function tag$01_text$02_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">a</div></div><div if.bind=\"false\"><div if.bind=\"false\">a</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$03 if$01 if$01 double$01 _", function tag$01_text$03_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">${msg}</div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 double$02 _", function tag$01_text$03_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 double$03 _", function tag$01_text$03_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">${msg}</div><div if.bind=\"true\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 nested$01 double$01 _", function tag$01_text$03_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 nested$01 double$02 _", function tag$01_text$03_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"><div if.bind=\"true\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 nested$01 double$03 _", function tag$01_text$03_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 nested$01 double$04 _", function tag$01_text$03_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\"></div></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$01 if$01 nested$01 double$05 _", function tag$01_text$03_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 double$01 _", function tag$01_text$03_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">${msg}</div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 double$02 _", function tag$01_text$03_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 double$03 _", function tag$01_text$03_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">${msg}</div><div if.bind=\"false\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 nested$01 double$01 _", function tag$01_text$03_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 nested$01 double$02 _", function tag$01_text$03_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"><div if.bind=\"false\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 nested$01 double$03 _", function tag$01_text$03_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 nested$01 double$04 _", function tag$01_text$03_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\"></div></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$03 if$02 else$01 nested$01 double$05 _", function tag$01_text$03_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$01 text$04 if$01 if$01 double$01 _", function tag$01_text$04_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">${msg}</div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 double$02 _", function tag$01_text$04_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 double$03 _", function tag$01_text$04_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\">${msg}</div><div if.bind=\"true\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 nested$01 double$01 _", function tag$01_text$04_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 nested$01 double$02 _", function tag$01_text$04_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"><div if.bind=\"true\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 nested$01 double$03 _", function tag$01_text$04_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 nested$01 double$04 _", function tag$01_text$04_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\"></div></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$01 if$01 nested$01 double$05 _", function tag$01_text$04_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div><div if.bind=\"true\"><div if.bind=\"true\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 double$01 _", function tag$01_text$04_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">${msg}</div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 double$02 _", function tag$01_text$04_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 double$03 _", function tag$01_text$04_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\">${msg}</div><div if.bind=\"false\">${msg}</div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 nested$01 double$01 _", function tag$01_text$04_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 nested$01 double$02 _", function tag$01_text$04_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"><div if.bind=\"false\"></div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 nested$01 double$03 _", function tag$01_text$04_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 nested$01 double$04 _", function tag$01_text$04_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\"></div></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$01 text$04 if$02 else$01 nested$01 double$05 _", function tag$01_text$04_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div><div if.bind=\"false\"><div if.bind=\"false\">${msg}</div></div></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$01 if$01 if$01 double$01 _", function tag$02_text$01_if$01_if$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 double$02 _", function tag$02_text$01_if$01_if$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 double$03 _", function tag$02_text$01_if$01_if$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 nested$01 double$01 _", function tag$02_text$01_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 nested$01 double$02 _", function tag$02_text$01_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 nested$01 double$03 _", function tag$02_text$01_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 nested$01 double$04 _", function tag$02_text$01_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$01 nested$01 double$05 _", function tag$02_text$01_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$02 double$01 _", function tag$02_text$01_if$01_if$02_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else>b</template><template if.bind=\"true\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$02 double$02 _", function tag$02_text$01_if$01_if$02_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else></template><template if.bind=\"true\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$02 double$03 _", function tag$02_text$01_if$01_if$02_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else>b</template><template if.bind=\"true\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$03 nested$01 double$01 _", function tag$02_text$01_if$01_if$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else>b</template></template><template if.bind=\"true\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$03 nested$01 double$01 _", function tag$02_text$01_if$01_if$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else>b</template></template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$03 nested$01 double$02 _", function tag$02_text$01_if$01_if$03_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else></template></template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$03 nested$01 double$03 _", function tag$02_text$01_if$01_if$03_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else>b</template></template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$04 double$01 _", function tag$02_text$01_if$01_if$04_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">a</template><template else>b</template><template if.bind=\"true\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$04 double$02 _", function tag$02_text$01_if$01_if$04_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else></template><template if.bind=\"true\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$04 double$03 _", function tag$02_text$01_if$01_if$04_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">a</template><template else>b</template><template if.bind=\"true\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$05 nested$01 double$01 _", function tag$02_text$01_if$01_if$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">a</template><template else>b</template></template><template else><template if.bind=\"true\">a</template><template else>b</template></template><template if.bind=\"true\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$05 nested$01 double$02 _", function tag$02_text$01_if$01_if$05_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else><template if.bind=\"true\"></template><template else></template></template><template if.bind=\"true\"><template if.bind=\"true\">a</template><template else>b</template></template><template else><template if.bind=\"true\">a</template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$01 if$01 if$05 nested$01 double$03 _", function tag$02_text$01_if$01_if$05_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">a</template><template else>b</template></template><template else><template if.bind=\"true\">a</template><template else>b</template></template><template if.bind=\"true\"><template if.bind=\"true\">a</template><template else>b</template></template><template else><template if.bind=\"true\">a</template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$01 if$01 if$06 sibling$01 _", function tag$02_text$01_if$01_if$06_sibling$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$01 if$06 sibling$02 _", function tag$02_text$01_if$01_if$06_sibling$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else if.bind=\"true\"></template><template if.bind=\"true\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$06 sibling$03 _", function tag$02_text$01_if$01_if$06_sibling$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template else if.bind=\"true\">b</template><template if.bind=\"true\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$01 if$06 sibling$04 _", function tag$02_text$01_if$01_if$06_sibling$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">a</template><template else if.bind=\"true\">b</template><template else if.bind=\"true\">a</template><template if.bind=\"true\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$01 double$01 _", function tag$02_text$01_if$02_else$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 double$02 _", function tag$02_text$01_if$02_else$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 double$03 _", function tag$02_text$01_if$02_else$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 nested$01 double$01 _", function tag$02_text$01_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 nested$01 double$02 _", function tag$02_text$01_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 nested$01 double$03 _", function tag$02_text$01_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 nested$01 double$04 _", function tag$02_text$01_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$01 nested$01 double$05 _", function tag$02_text$01_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$02 double$01 _", function tag$02_text$01_if$02_else$02_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else>b</template><template if.bind=\"false\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$02 double$02 _", function tag$02_text$01_if$02_else$02_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else></template><template if.bind=\"false\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$02 double$03 _", function tag$02_text$01_if$02_else$02_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else>b</template><template if.bind=\"false\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$03 nested$01 double$01 _", function tag$02_text$01_if$02_else$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else>b</template></template><template if.bind=\"false\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$03 nested$01 double$01 _", function tag$02_text$01_if$02_else$03_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else>b</template></template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$03 nested$01 double$02 _", function tag$02_text$01_if$02_else$03_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else></template></template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$03 nested$01 double$03 _", function tag$02_text$01_if$02_else$03_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else>b</template></template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$04 double$01 _", function tag$02_text$01_if$02_else$04_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">a</template><template else>b</template><template if.bind=\"false\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$04 double$02 _", function tag$02_text$01_if$02_else$04_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else></template><template if.bind=\"false\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$04 double$03 _", function tag$02_text$01_if$02_else$04_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">a</template><template else>b</template><template if.bind=\"false\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$05 nested$01 double$01 _", function tag$02_text$01_if$02_else$05_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">a</template><template else>b</template></template><template else><template if.bind=\"false\">a</template><template else>b</template></template><template if.bind=\"false\"></template><template else></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$05 nested$01 double$02 _", function tag$02_text$01_if$02_else$05_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else><template if.bind=\"false\"></template><template else></template></template><template if.bind=\"false\"><template if.bind=\"false\">a</template><template else>b</template></template><template else><template if.bind=\"false\">a</template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$01 if$02 else$05 nested$01 double$03 _", function tag$02_text$01_if$02_else$05_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">a</template><template else>b</template></template><template else><template if.bind=\"false\">a</template><template else>b</template></template><template if.bind=\"false\"><template if.bind=\"false\">a</template><template else>b</template></template><template else><template if.bind=\"false\">a</template><template else>b</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$01 if$02 else$06 sibling$01 _", function tag$02_text$01_if$02_else$06_sibling$01__() {
        const { au, host } = setup();
    ...
    it("tag$02 text$01 if$02 else$06 sibling$02 _", function tag$02_text$01_if$02_else$06_sibling$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else if.bind=\"false\"></template><template if.bind=\"false\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$06 sibling$03 _", function tag$02_text$01_if$02_else$06_sibling$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template else if.bind=\"false\">b</template><template if.bind=\"false\">a</template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$01 if$02 else$06 sibling$04 _", function tag$02_text$01_if$02_else$06_sibling$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">a</template><template else if.bind=\"false\">b</template><template else if.bind=\"false\">a</template><template if.bind=\"false\"></template><template else>b</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
        });
        const component = new App();
    ...
    it("tag$02 text$02 if$01 if$01 double$01 _", function tag$02_text$02_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">a</template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 double$02 _", function tag$02_text$02_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\">a</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 double$03 _", function tag$02_text$02_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">a</template><template if.bind=\"true\">a</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 nested$01 double$01 _", function tag$02_text$02_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 nested$01 double$02 _", function tag$02_text$02_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 nested$01 double$03 _", function tag$02_text$02_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 nested$01 double$04 _", function tag$02_text$02_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$01 if$01 nested$01 double$05 _", function tag$02_text$02_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template><template if.bind=\"true\"><template if.bind=\"true\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 double$01 _", function tag$02_text$02_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">a</template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 double$02 _", function tag$02_text$02_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\">a</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 double$03 _", function tag$02_text$02_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">a</template><template if.bind=\"false\">a</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 nested$01 double$01 _", function tag$02_text$02_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 nested$01 double$02 _", function tag$02_text$02_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template><template if.bind=\"false\"><template if.bind=\"false\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 nested$01 double$03 _", function tag$02_text$02_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 nested$01 double$04 _", function tag$02_text$02_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\"></template></template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$02 if$02 else$01 nested$01 double$05 _", function tag$02_text$02_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template><template if.bind=\"false\"><template if.bind=\"false\">a</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$03 if$01 if$01 double$01 _", function tag$02_text$03_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">${msg}</template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 double$02 _", function tag$02_text$03_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 double$03 _", function tag$02_text$03_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">${msg}</template><template if.bind=\"true\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 nested$01 double$01 _", function tag$02_text$03_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 nested$01 double$02 _", function tag$02_text$03_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 nested$01 double$03 _", function tag$02_text$03_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 nested$01 double$04 _", function tag$02_text$03_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$01 if$01 nested$01 double$05 _", function tag$02_text$03_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 double$01 _", function tag$02_text$03_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">${msg}</template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 double$02 _", function tag$02_text$03_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 double$03 _", function tag$02_text$03_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">${msg}</template><template if.bind=\"false\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 nested$01 double$01 _", function tag$02_text$03_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 nested$01 double$02 _", function tag$02_text$03_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"><template if.bind=\"false\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 nested$01 double$03 _", function tag$02_text$03_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 nested$01 double$04 _", function tag$02_text$03_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\"></template></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$03 if$02 else$01 nested$01 double$05 _", function tag$02_text$03_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
            msg = "a";
            not = "b";
    ...
    it("tag$02 text$04 if$01 if$01 double$01 _", function tag$02_text$04_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">${msg}</template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 double$02 _", function tag$02_text$04_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 double$03 _", function tag$02_text$04_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\">${msg}</template><template if.bind=\"true\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 nested$01 double$01 _", function tag$02_text$04_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 nested$01 double$02 _", function tag$02_text$04_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 nested$01 double$03 _", function tag$02_text$04_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 nested$01 double$04 _", function tag$02_text$04_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$01 if$01 nested$01 double$05 _", function tag$02_text$04_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template><template if.bind=\"true\"><template if.bind=\"true\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 double$01 _", function tag$02_text$04_if$02_else$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">${msg}</template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 double$02 _", function tag$02_text$04_if$02_else$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 double$03 _", function tag$02_text$04_if$02_else$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\">${msg}</template><template if.bind=\"false\">${msg}</template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 nested$01 double$01 _", function tag$02_text$04_if$02_else$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 nested$01 double$02 _", function tag$02_text$04_if$02_else$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"><template if.bind=\"false\"></template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 nested$01 double$03 _", function tag$02_text$04_if$02_else$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 nested$01 double$04 _", function tag$02_text$04_if$02_else$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\"></template></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$02 text$04 if$02 else$01 nested$01 double$05 _", function tag$02_text$04_if$02_else$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template><template if.bind=\"false\"><template if.bind=\"false\">${msg}</template></template></template>";
        const name = "app";
        const App = CustomElementResource.define({ name, template }, class {
    ...
    it("tag$03 text$03 if$01 if$01 double$01 _", function tag$03_text$03_if$01_if$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 double$02 _", function tag$03_text$03_if$01_if$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 double$03 _", function tag$03_text$03_if$01_if$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 nested$01 double$01 _", function tag$03_text$03_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 nested$01 double$02 _", function tag$03_text$03_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 nested$01 double$03 _", function tag$03_text$03_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 nested$01 double$04 _", function tag$03_text$03_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$03 if$01 if$01 nested$01 double$05 _", function tag$03_text$03_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
    ...
    it("tag$03 text$04 if$01 if$01 double$01 _", function tag$03_text$04_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 double$02 _", function tag$03_text$04_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 double$03 _", function tag$03_text$04_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 nested$01 double$01 _", function tag$03_text$04_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 nested$01 double$02 _", function tag$03_text$04_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 nested$01 double$03 _", function tag$03_text$04_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 nested$01 double$04 _", function tag$03_text$04_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$03 text$04 if$01 if$01 nested$01 double$05 _", function tag$03_text$04_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 double$01 _", function tag$04_text$03_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 double$02 _", function tag$04_text$03_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 double$03 _", function tag$04_text$03_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 nested$01 double$01 _", function tag$04_text$03_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 nested$01 double$02 _", function tag$04_text$03_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 nested$01 double$03 _", function tag$04_text$03_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 nested$01 double$04 _", function tag$04_text$03_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$03 if$01 if$01 nested$01 double$05 _", function tag$04_text$03_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 double$01 _", function tag$04_text$04_if$01_if$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 double$02 _", function tag$04_text$04_if$01_if$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 double$03 _", function tag$04_text$04_if$01_if$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 nested$01 double$01 _", function tag$04_text$04_if$01_if$01_nested$01_double$01__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 nested$01 double$02 _", function tag$04_text$04_if$01_if$01_nested$01_double$02__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 nested$01 double$03 _", function tag$04_text$04_if$01_if$01_nested$01_double$03__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 nested$01 double$04 _", function tag$04_text$04_if$01_if$01_nested$01_double$04__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
    ...
    it("tag$04 text$04 if$01 if$01 nested$01 double$05 _", function tag$04_text$04_if$01_if$01_nested$01_double$05__() {
        const { au, host } = setup();
        const template = "<template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template><template if.bind=\"true\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>";
        const name = "app";
        const Foo = CustomElementResource.define({ name: "foo", template: "<template>${msg}${not}${item}</template>" }, class {
