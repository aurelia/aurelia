...
describe("generated.template-compiler.static.if-else.repeat", function () {
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$04 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$05 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\" if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$06 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$07 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$08$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template else></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$09 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$11 variant$09$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template><template else></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$04 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$05 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\" if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$06 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$07 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$08$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"true\"><foo msg.bind=\"msg\"></foo></template><template else></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$09 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$12 variant$09$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template><template else></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\"><foo item.bind=\"item\"></foo></template><template else><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template><template else repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$04 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$05 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\" if.bind=\"true\"><foo item.bind=\"item\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$06 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$07 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$08$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\"><foo item.bind=\"item\"></foo></template><template else></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$01 repeat$13 variant$09$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template><template else></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 1\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$10$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\"></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$11 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else><template repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$11$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$11 variant$12 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 1\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template></template><template else><template repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"i of 3\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$10$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 3\"><template if.bind=\"false\"></template><template else><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$11 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else><template repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$11$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$12 variant$12 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo msg.bind=\"msg\"></foo></template><template else repeat.for=\"i of 3\"><foo not.bind=\"not\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$01 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"false\"><foo item.bind=\"item\"></foo></template><template else><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$02 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$03 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\" repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template><template else repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$10$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"false\"></template><template else><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$11 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo item.bind=\"item\"></foo></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$11$empty _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$03 text$03 if$02 repeat$13 variant$12 _", function () {
        ...
        au.register(Foo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><foo item.bind=\"item\"></foo></template><template else repeat.for=\"item of ['a', 'b', 'c']\"><foo item.bind=\"item\"></foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
