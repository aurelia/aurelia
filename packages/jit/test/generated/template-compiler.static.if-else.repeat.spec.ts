...
describe("generated.template-compiler.static.if-else.repeat", function () {
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$01 _", function () {
        const { au, host } = setup();
        const MyFoo = CustomElementResource.define({ name: "my-foo", template: "<template><template replaceable part=\"the-part\"></template><template replaceable part=\"the-not-part\"></template></template>" }, class {
            static bindables = { msg: { property: "msg", attribute: "msg" }, not: { property: "not", attribute: "not" }, item: { property: "item", attribute: "item" } };
            msg = "";
            not = "";
            item = "";
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template><template else><my-foo not.bind=\"not\"><template replace-part=\"the-not-part\">${not}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$04 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$05 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\" if.bind=\"true\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$06 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$07 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"i of 1\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$08$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"true\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template><template else></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$11 variant$09$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"i of 1\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template></template><template else></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$04 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$05 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\" if.bind=\"true\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$06 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$07 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\" repeat.for=\"item of ['a', 'b', 'c']\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$08$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"true\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template><template else></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$01 repeat$13 variant$09$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"true\"><template repeat.for=\"item of ['a', 'b', 'c']\"><my-foo item.bind=\"item\"><template replace-part=\"the-part\">${item}</template></my-foo></template></template><template else></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$02 repeat$11 variant$10$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"i of 1\"><template if.bind=\"false\"></template><template else><my-foo not.bind=\"not\"><template replace-part=\"the-not-part\">${not}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$02 repeat$11 variant$11$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"i of 1\"><my-foo not.bind=\"not\"><template replace-part=\"the-not-part\">${not}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$02 repeat$11 variant$12 _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"><my-foo msg.bind=\"msg\"><template replace-part=\"the-part\">${msg}</template></my-foo></template><template else repeat.for=\"i of 1\"><my-foo not.bind=\"not\"><template replace-part=\"the-not-part\">${not}</template></my-foo></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$02 repeat$13 variant$10$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template repeat.for=\"item of ['a', 'b', 'c']\"><template if.bind=\"false\"></template><template else><my-foo item.bind=\"item\"><template replace-part=\"the-item-part\">${item}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
    ...
    it("tag$04 text$03 if$02 repeat$13 variant$11$empty _", function () {
        ...
        au.register(MyFoo);
        const App = CustomElementResource.define({ name: "app", template: "<template><template if.bind=\"false\"></template><template else><template repeat.for=\"item of ['a', 'b', 'c']\"><my-foo item.bind=\"item\"><template replace-part=\"the-item-part\">${item}</template></my-foo></template></template></template>" }, class {
            msg = "a";
            not = "b";
        });
        const component = new App();
