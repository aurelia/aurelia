...
export { Class, Constructable, ConstructableClass, IDisposable, IIndexable, IPerformance, ITimerHandler, IWindowOrWorkerGlobalScope, Omit, Overwrite, Primitive, StrictPrimitive, Unwrap, Writable, } from './interfaces';
