...
import { Metadata as L } from "../../../metadata/dist/native-modules/index.mjs";
...
class LoadCustomAttribute {
    ...
    binding() {
        ...
        this.valueChanged();
        this.Cs = this.I.subscribe("au:router:navigation-end", (t => {
