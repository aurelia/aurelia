...
class RouteExpression {
    ...
    toInstructionTree(options) {
        return new instructions_js_1.ViewportInstructionTree(options, this.isAbsolute, this.root.toInstructions(options.append, 0, 0), this.queryParams, this.fragment);
    }
    toString() {
        return this.raw;
    }
