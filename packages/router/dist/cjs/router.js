...
let Router = class Router {
    ...
    getRouteContext(viewportAgent, component, renderContext) {
        ...
        if (routeContext === void 0) {
            ...
            const parent = container.has(route_context_js_1.IRouteContext, true) ? container.get(route_context_js_1.IRouteContext) : null;
            routeDefinitionLookup.set(routeDefinition, routeContext = new route_context_js_1.RouteContext(viewportAgent, parent, component, routeDefinition, container));
        }
        else {
