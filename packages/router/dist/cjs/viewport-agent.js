...
exports.ViewportAgent = exports.ViewportRequest = void 0;
...
exports.ViewportRequest = ViewportRequest;
...
class ViewportAgent {
    ...
    static for(viewport, ctx) {
        ...
        if (viewportAgent === void 0) {
            const controller = runtime_html_1.Controller.getCachedOrThrow(viewport);
    ...
    activateFromViewport(initiator, parent, flags) {
        ...
        switch (this.nextState) {
            ...
            case 2 /* nextLoadDone */: {
                ...
                const b = util_js_1.Batch.start(b1 => { this.activate(initiator, this.currTransition, b1); });
    ...
    deactivateFromViewport(initiator, parent, flags) {
        ...
        switch (this.currState) {
            ...
            default: {
                ...
                const b = util_js_1.Batch.start(b1 => { this.deactivate(initiator, this.currTransition, b1); });
                const p = new Promise(resolve => { b.continueWith(() => { resolve(); }); });
                return b.start().done ? void 0 : p;
            }
        }
        ...
        util_js_1.Batch.start(b1 => {
            ...
            switch (this.$plan) {
                ...
                case 'invoke-lifecycles':
                    ...
                    b1.push();
                    void kernel_1.onResolve(route_tree_js_1.processResidue(next), () => {
                        b1.pop();
                    });
                    return;
                case 'replace':
            ...
            case 256 /* currUnloadDone */:
                ...
                switch (this.$plan) {
                    ...
                    case 'replace': {
                        ...
                        const deactivateFlags = this.viewport.stateful ? 0 /* none */ : 512 /* dispose */;
                        tr.run(() => {
    ...
    swap(tr, b) {
        ...
        switch (this.$plan) {
            ...
            case 'invoke-lifecycles': {
                ...
                const nodes = util_js_1.mergeDistinct(this.nextNode.children, this.currNode.children);
    ...
    processDynamicChildren(tr, b) {
        ...
        tr.run(() => {
            b.push();
            return route_tree_js_1.getDynamicChildren(next);
        }, newChildren => {
            util_js_1.Batch.start(b1 => {
