...
class ViewportInstruction {
    ...
    toComponentType(container) {
        ...
        if (this.componentName !== null
            ...
            && container !== null
            && container.has(runtime_html_1.CustomElement.keyFrom(this.componentName), true)) {
            const resolver = container.getResolver(runtime_html_1.CustomElement.keyFrom(this.componentName));
    ...
    toComponentInstance(container) {
        ...
        if (container !== void 0 && container !== null) {
            const instance = this.isComponentType()
                ...
                : container.get(runtime_html_1.CustomElement.keyFrom(this.componentName));
