...
import { DI, InstanceProvider, Registration, ILogger, IModuleLoader, onResolve, noop } from '@aurelia/kernel';
import { CustomElement, IController, isCustomElementViewModel, isCustomElementController, IAppRoot, IPlatform } from '@aurelia/runtime-html';
