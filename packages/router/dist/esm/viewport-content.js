...
export class ViewportContent {
    ...
    contentController(connectedCE) {
        return Controller.forCustomElement(null, connectedCE.container, this.content.componentInstance, connectedCE.element, null, void 0);
    }
    ...
    deactivateComponent(initiator, parent, flags, connectedCE, stateful = false) {
        ...
        const contentController = this.contentController(connectedCE);
        return Runner.run(() => contentController.deactivate(initiator ?? contentController, parent, flags));
    }
