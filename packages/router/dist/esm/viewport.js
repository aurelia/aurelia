...
export class Viewport {
    ...
    load(recurse) {
        ...
        //   return;
        // }
        return Runner.run(() => this.nextContent?.load(this.content.instruction));
    ...
    deactivate(initiator, parent, flags) {
        if (this.content.componentInstance &&
            ...
            return Runner.run(() => this.content?.unload(this.content.instruction), // Only acts if not already unloaded
