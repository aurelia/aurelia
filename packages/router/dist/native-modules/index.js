import { DI as t, IEventAggregator as e, ILogger as i, bound as s, onResolve as n, resolveAll as o, isObject as r, IContainer as a, isArrayIndex as h, Metadata as c, Protocol as u, emptyArray as l, IModuleLoader as d, InstanceProvider as f, noop as p, Registration as g } from "../../../kernel/dist/native-modules/index.js";

import { isCustomElementViewModel as v, IHistory as w, ILocation as m, IWindow as $, Controller as x, CustomElement as y, IPlatform as E, CustomElementDefinition as S, IController as b, IAppRoot as R, isCustomElementController as C, bindable as k, customElement as I, BindingMode as N, customAttribute as T, IEventTarget as V, INode as A, IEventDelegator as P, getRef as L, CustomAttribute as U, AppTask as O } from "../../../runtime-html/dist/native-modules/index.js";
...
class ComponentAgent {
    constructor(t, e, s, n, o) {
        ...
        this.routeNode = n;
        this.ctx = o;
        this.logger = o.container.get(i).scopeTo(`ComponentAgent<${o.friendlyPath}>`);
        this.logger.trace(`constructor()`);
        ...
        this.hasCanLoad = "canLoad" in t;
        this.hasLoad = "load" in t;
        this.hasCanUnload = "canUnload" in t;
        this.hasUnload = "unload" in t;
    }
    static for(t, e, i, s) {
        let n = zt.get(t);
        if (void 0 === n) {
...
class RouteContext {
    constructor(t, e, s, n, o) {
        ...
        if (c.length > 0) this.h = Promise.all(c).then((() => {
            this.h = null;
        }));
        if (u.length > 0) this.u = Promise.all(u).then((() => {
            this.u = null;
        }));
    }
    get id() {
