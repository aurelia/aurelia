...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/runtime", "@aurelia/runtime-html", "../router", "../type-resolvers"], factory);
    }
    ...
    let LoadCustomAttribute = /** @class */ (() => {
        let LoadCustomAttribute = class LoadCustomAttribute {
            ...
            handleChange() {
                const controller = runtime_1.CustomAttribute.for(this.element, 'load').parent;
        ...
        LoadCustomAttribute = __decorate([
            runtime_1.customAttribute('load'),
