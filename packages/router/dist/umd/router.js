(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "@aurelia/runtime", "./instruction-resolver", "./link-handler", "./nav", "./navigator", "./type-resolvers", "./utils", "./viewport", "./viewport-instruction", "./found-route", "./hook-manager", "./scope", "./viewport-scope", "./browser-viewer-store", "./navigation", "./navigation-coordinator", "./router-options", "./open-promise"], factory);
    }
