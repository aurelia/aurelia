(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/runtime", "./parser", "./viewport-instruction", "./navigation", "./runner", "./awaitable-map"], factory);
    }
    ...
    class ViewportContent {
        ...
        contentController(connectedCE) {
            return runtime_1.Controller.forCustomElement(null, connectedCE.container, this.content.componentInstance, connectedCE.container.get(runtime_1.ILifecycle), connectedCE.element, null, void 0);
        }
