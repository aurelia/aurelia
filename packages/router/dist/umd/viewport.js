(function (factory) {
    ...
    class Viewport {
        ...
        setNextContent(content, instruction) {
            ...
            this.nextContent = new viewport_content_1.ViewportContent(!this.clear ? content : null, parameters, instruction, this.context);
        ...
        async loadContent() {
            ...
            if (this.clear) {
                this.content = new viewport_content_1.ViewportContent(null, void 0, this.nextContent.instruction);
            }
            this.nextContent = null;
            return true;
        }
        ...
        description(full = false) {
            if (this.content.content) {
                ...
                return this.router.instructionResolver.stringifyViewportInstruction(new viewport_instruction_1.ViewportInstruction(component, void 0, this.content.parameters, this.scope !== null));
            }
            return '';
        }
