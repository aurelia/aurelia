(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/runtime", "./utils", "./viewport-content", "./scope", "./runner"], factory);
    }
    ...
    class Viewport {
        ...
        getComponentType() {
            ...
            if (componentType === null) {
                const controller = runtime_1.CustomElement.for(this.connectedCE.element);
