import { LifecycleFlags, IHydratedController, IHydratedParentController } from '@aurelia/runtime';
...
export declare class Viewport implements IScopeOwner {
    ...
    activate(initiator: IHydratedController<Element> | null, parent: IHydratedParentController<Element> | null, flags: LifecycleFlags, fromParent: boolean): void | Promise<void>;
    deactivate(initiator: IHydratedController<Element> | null, parent: IHydratedParentController<Element> | null, flags: LifecycleFlags): void | Promise<void>;
