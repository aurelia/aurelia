...
export class Scope {
  ...
  public foundViewport(instruction: ViewportInstruction, viewport: Viewport, withoutViewports: boolean, alreadyFound: boolean = false): IFindViewportsResult {
    // if (!withoutViewports) {
