    ...
    compileCustomElement(symbol, instructionRows, compilationInstruction) {
        ...
        if (isAuSlot) {
            ...
            slotInfo = targetedProjection !== void 0
                ...
                : new au_slot_js_1.SlotInfo(slotName, au_slot_js_1.AuSlotContentType.Fallback, this.compileProjectionFallback(symbol, compilationInstruction));
        }
        instructionRow[0] = new renderer_js_1.HydrateElementInstruction(symbol.res, symbol.info.alias, this.compileBindings(symbol), this.compileProjections(symbol, compilationInstruction), slotInfo);
    ...
    compileProjections(symbol, compilationInstruction) {
        ...
        for (let i = 0; i < len; ++i) {
            ...
            if (definition === void 0) {
                ...
                compiledProjections[name] = custom_element_js_1.CustomElementDefinition.create({ name, template, instructions, needsCompile: false });
            }
            else {
