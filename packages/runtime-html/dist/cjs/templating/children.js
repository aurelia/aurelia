...
class ChildrenDefinition {
    ...
    static create(prop, def = {}) {
        return new ChildrenDefinition(kernel_1.firstDefined(def.callback, `${prop}Changed`), kernel_1.firstDefined(def.property, prop), def.options ?? childObserverOptions, def.query, def.filter, def.map);
    }
}
