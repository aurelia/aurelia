...
class Controller {
    ...
    host) {
        ...
        this.childrenObs = kernel_1.emptyArray;
        this.$initiator = null;
        this.$flags = 0 /* none */;
        this.$resolve = void 0;
        this.$reject = void 0;
    ...
    definition) {
        ...
        definition = definition !== null && definition !== void 0 ? definition : custom_attribute_js_1.CustomAttribute.getDefinition(viewModel.constructor);
        const controller = new Controller(
        /* root           */ root, 
        /* context ct     */ context, 
    ...
    if (length > 0) {
        ...
        for (; i < length; ++i) {
            ...
            if (observers[name] == void 0) {
                ...
                obs[obs.length] = observers[name] = new children_js_1.ChildrenObserver(controller, instance, name, childrenDescription.callback, childrenDescription.query, childrenDescription.filter, childrenDescription.map, childrenDescription.options);
            }
        }
        return obs;
    }
...
function createWatchers(controller, context, definition, instance) {
    ...
    const scope = controller.vmKind === 0 /* customElement */
        ...
        : runtime_1.Scope.create(instance, null, true);
    ...
    for (; ii > i; ++i) {
        ...
        if (typeof expression === 'function') {
            ...
            controller.addBinding(new watchers_js_1.ExpressionWatcher(scope, context, observerLocator, ast, callback));
        }
    }
}
