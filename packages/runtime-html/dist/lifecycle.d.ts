import { IContainer, IIndexable, IDisposable } from '@aurelia/kernel';
...
export interface ISyntheticView extends IComposableController, IHydratedControllerProperties {
    ...
    cancel(initiator: IHydratedController, parent: IHydratedComponentController, flags: LifecycleFlags): void;
    /**
...
export interface ICustomAttributeController<C extends ICustomAttributeViewModel = ICustomAttributeViewModel> extends IComponentController<C>, IHydratedControllerProperties {
    ...
    cancel(initiator: IHydratedController, parent: IHydratedParentController, flags: LifecycleFlags): void;
}
/**
...
export interface ICustomElementController<C extends ICustomElementViewModel = ICustomElementViewModel> extends ICompiledCustomElementController<C> {
    ...
    cancel(initiator: IHydratedController, parent: IHydratedParentController | null, flags: LifecycleFlags): void;
}
...
export interface IActivationHooks<TParent> {
    beforeBind?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    afterBind?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    afterAttach?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    afterAttachChildren?(initiator: IHydratedController, flags: LifecycleFlags): void | Promise<void>;
    beforeDetach?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    beforeUnbind?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    afterUnbind?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void | Promise<void>;
    afterUnbindChildren?(initiator: IHydratedController, flags: LifecycleFlags): void | Promise<void>;
    onCancel?(initiator: IHydratedController, parent: TParent, flags: LifecycleFlags): void;
    dispose?(): void;
    /**
...
export interface ICompileHooks {
    ...
    beforeCompose?(controller: IContextualCustomElementController<this>): void;
    beforeComposeChildren?(controller: ICompiledCustomElementController<this>): void;
    afterCompose?(controller: ICustomElementController<this>): void;
}
/**
