...
export declare class ContentBinding implements IBinding, ISubscriber, ICollectionSubscriber {
    ...
    constructor(controller: IBindingController, locator: IServiceLocator, observerLocator: IObserverLocator, p: IPlatform, ast: IsExpression, target: Text, strict: boolean);
