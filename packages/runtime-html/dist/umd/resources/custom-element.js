(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "@aurelia/runtime", "../dom", "../templating/children"], factory);
    }
    ...
    class CustomElementDefinition {
        constructor(Type, name, aliases, key, cache, template, instructions, dependencies, injectable, needsCompile, surrogates, bindables, childrenObservers, containerless, isStrictBinding, shadowOptions, hasSlots, strategy, enhance, projectionsMap) {
            this.Type = Type;
            this.name = name;
        ...
        for(node, opts = defaultForOpts) {
            ...
            if (opts.name !== void 0) {
                ...
                while (cur !== null) {
                    ...
                    cur = dom_1.getEffectiveParentNode(cur);
                }
                if (foundAController) {
                    return (void 0);
                }
