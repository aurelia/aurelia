(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "@aurelia/runtime", "../definitions", "../dom", "../templating/children"], factory);
    }
    ...
    class CustomElementDefinition {
        ...
        static create(nameOrDef, Type = null) {
            ...
            if (typeof nameOrDef === 'string') {
                ...
                kernel_1.fromAnnotationOrTypeOrDefault('hooks', Type, () => new definitions_1.HooksDefinition(Type.prototype)), kernel_1.fromAnnotationOrTypeOrDefault('enhance', Type, () => false), kernel_1.fromAnnotationOrTypeOrDefault('projectionsMap', Type, () => new Map()));
            }
            ...
            // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
            kernel_1.fromAnnotationOrTypeOrDefault('hooks', Type, () => new definitions_1.HooksDefinition(Type.prototype)), kernel_1.fromAnnotationOrDefinitionOrTypeOrDefault('enhance', nameOrDef, Type, () => false), kernel_1.fromAnnotationOrDefinitionOrTypeOrDefault('projectionsMap', nameOrDef, Type, () => new Map()));
        }
