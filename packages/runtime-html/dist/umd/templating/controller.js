(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "@aurelia/runtime", "../definitions", "../lifecycle", "../resources/custom-element", "../resources/custom-attribute", "./composition-context", "./children", "../app-root", "../projectors", "../platform"], factory);
    }
    ...
    const composition_context_1 = require("./composition-context");
    ...
    class Controller {
        constructor(root, container, vmKind, flags, definition, hooks, 
        /**
        ...
        hydrateCustomElement(parentContainer, targetedProjections) {
            ...
            this.scope = runtime_1.Scope.create(flags, this.bindingContext, null);
            ...
            const context = this.context = composition_context_1.getCompositionContext(definition, parentContainer, targetedProjections === null || targetedProjections === void 0 ? void 0 : targetedProjections.projections);
        ...
        compile(targetedProjections) {
            if (this.hooks.hasBeforeCompose) {
                ...
                this.viewModel.beforeCompose(this);
            }
            ...
            const projectorLocator = this.context.get(projectors_1.IProjectorLocator);
            this.projector = projectorLocator.getElementProjector(this, this.host, compiledDefinition);
            ...
            if (this.hooks.hasBeforeComposeChildren) {
                ...
                this.viewModel.beforeComposeChildren(this);
            }
        }
        /** @internal */
        compileChildren() {
            ...
            if (this.hooks.hasAfterCompose) {
                ...
                this.viewModel.afterCompose(this);
            }
        }
    ...
    function getBindingContext(flags, instance) {
        ...
        return runtime_1.ProxyObserver.getOrCreate(instance).proxy;
    }
        ...
        if (length > 0) {
            ...
            if ((flags & 2 /* proxyStrategy */) > 0) {
                for (let i = 0; i < length; ++i) {
                    ...
                    new runtime_1.BindableObserver(lifecycle, flags, runtime_1.ProxyObserver.getOrCreate(instance).proxy, name, bindable.callback, bindable.set);
                }
            }
            else {
