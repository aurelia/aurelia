...
import { CompositionRoot, ICompositionRoot, IDOM, ISinglePageApp } from '@aurelia/runtime';
...
export class Aurelia implements IDisposable {
  ...
  private _root: ICompositionRoot<HTMLElement> | undefined = void 0;
  public get root(): ICompositionRoot<HTMLElement> {
  ...
  private next: ICompositionRoot<HTMLElement> | undefined = void 0;

  private readonly rootProvider: InstanceProvider<ICompositionRoot<HTMLElement>>;
  ...
  public start(root: ICompositionRoot<HTMLElement> | undefined = this.next): void | Promise<void> {
    if (root == void 0) {
  ...
  private dispatchEvent(root: ICompositionRoot, name: string, target: IDOM<HTMLElement> | (HTMLElement & Partial<Publisher>)): void {
