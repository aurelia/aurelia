...
import { ClassListObserver } from '../observation/element-attribute-observer';
...
export interface ClassListBinding extends IConnectableBinding {}

@connectable()
export class ClassListBinding implements IPartialConnectableBinding {
