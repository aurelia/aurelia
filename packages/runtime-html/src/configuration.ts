...
import { TargetAccessorLocator, TargetObserverLocator } from './observation/observer-locator.js';
...
import { FrequentMutations, InfrequentMutations, ObserveShallow } from './resources/template-controllers/flags.js';
