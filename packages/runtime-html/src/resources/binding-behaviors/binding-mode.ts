...
const createConfig = (name: string): BindingBehaviorStaticAuDefinition => ({ type: 'binding-behavior', name });
...
export class TwoWayBindingBehavior extends BindingModeBehavior {
  public static readonly $au = createConfig('twoWay');
