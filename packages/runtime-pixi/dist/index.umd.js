(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@aurelia/kernel'), require('@aurelia/runtime-html-browser'), require('@aurelia/runtime'), require('pixi.js')) :
    typeof define === 'function' && define.amd ? define(['exports', '@aurelia/kernel', '@aurelia/runtime-html-browser', '@aurelia/runtime', 'pixi.js'], factory) :
    (global = global || self, factory(global.runtimePixi = {}, global.kernel, global.runtimeHtmlBrowser, global.runtime, global.pixi_js));
}(this, function (exports, kernel, runtimeHtmlBrowser, runtime, pixi_js) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.PixiApp = class PixiApp {
        ...
        bound() {
            ...
            if (this.options instanceof Object) {
                this._app = new pixi_js.Application(Object.assign({}, this.options, boundOptions));
            }
            else {
    ...
    const BasicConfiguration = {
         ...
         */
        register(container) {
            return runtimeHtmlBrowser.BasicConfiguration
                .register(container)
