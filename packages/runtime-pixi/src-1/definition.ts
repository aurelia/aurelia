...
import { BindingMode, CustomElementConstructor, DelegationStrategy, ForOfStatement, ICustomElement, ICustomElementHost, INode, Interpolation, IResourceDefinition, IsBindingBehavior, ResourceDescription } from '@aurelia/runtime';
