...
import { INodeSequence, IRenderLocation } from '@aurelia/runtime';
import { IAttach, IBindScope, ILifecycle, ILifecycleUnbind, IMountable, IRenderContext, IView, IViewCache, IViewFactory, State } from '@aurelia/runtime';
...
import { ITemplate } from '@aurelia/runtime';
...
function lockedBind(this: View, flags: LifecycleFlags): void {
  ...
  while (current !== null) {
    ...
    current = (current as any).$nextBind;
  }
