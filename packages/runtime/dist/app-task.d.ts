...
export declare type TaskSlot = ('beforeCreate' | 'beforeCompile' | 'beforeCompileChildren' | 'beforeActivate' | 'afterActivate' | 'beforeDeactivate' | 'afterDeactivate');
...
export interface ICallbackSlotChooser<K extends Key> extends Pick<$AppTask<K>, 'beforeCreate' | 'beforeCompile' | 'beforeCompileChildren' | 'beforeActivate' | 'afterActivate' | 'beforeDeactivate' | 'afterDeactivate'> {
}
