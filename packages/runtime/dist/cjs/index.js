...
class BindingContext {
    ...
    static get(t, e, r, s) {
        ...
        if (r > 0) {
            ...
            h = u.overrideContext;
            return e in h ? h : h.bindingContext;
        }
        while (!(null === u || void 0 === u ? void 0 : u.isBoundary) && null != h && !(e in h) && !(h.bindingContext && e in h.bindingContext)) {
            u = null !== (n = u.parentScope) && void 0 !== n ? n : null;
            h = null !== (o = null === u || void 0 === u ? void 0 : u.overrideContext) && void 0 !== o ? o : null;
        }
        if (h) return e in h ? h : h.bindingContext;
        if (16 & s) return i;
...
class BindingBehaviorDefinition {
    ...
    static create(e, r) {
        ...
        return new BindingBehaviorDefinition(r, t.firstDefined(o(r, "name"), s), t.mergeArrays(o(r, "aliases"), i.aliases, r.aliases), u.keyFrom(s), t.fromAnnotationOrDefinitionOrTypeOrDefault("strategy", i, r, (() => n ? 2 : 1)));
    }
    register(e) {
...
const h = t.Protocol.resource.keyFor("binding-behavior");
...
const u = Object.freeze({
    ...
    isType(e) {
        return "function" === typeof e && t.Metadata.hasOwn(h, e);
    },
    define(e, r) {
        const s = BindingBehaviorDefinition.create(e, r);
        t.Metadata.define(h, s, s.Type);
        t.Metadata.define(h, s, s);
        t.Protocol.resource.appendTo(r, h);
        return s.Type;
    },
    getDefinition(e) {
        const r = t.Metadata.getOwn(h, e);
        if (void 0 === r) throw new Error(`AUR0151:${e.name}`);
        return r;
    },
    annotate(e, r, s) {
...
class ValueConverterDefinition {
    ...
    static create(e, r) {
        ...
        const n = l.getAnnotation;
        return new ValueConverterDefinition(r, t.firstDefined(n(r, "name"), s), t.mergeArrays(n(r, "aliases"), i.aliases, r.aliases), l.keyFrom(s));
    }
    register(e) {
...
const l = Object.freeze({
    ...
    getDefinition(e) {
        ...
        if (void 0 === r) throw new Error(`AUR0152:${e.name}`);
        return r;
    },
    annotate(e, r, s) {
        t.Metadata.define(t.Protocol.annotation.keyFor(r), s, e);
...
function $() {
    return m(this, "subs", new SubscriberRecord);
}
...
class CollectionLengthObserver {
    ...
    flush() {
        ...
        this.subs.notify(this.value, F, this.f);
    }
}
...
function j(t) {
    const e = t.prototype;
    E(e, "subscribe", I, true);
    E(e, "unsubscribe", M, true);
    P(t);
    S(t);
}
...
const Y = [ "push", "unshift", "pop", "shift", "splice", "reverse", "sort" ];
...
const tt = {
    ...
    splice: function(...t) {
        ...
        const r = t[1];
        const s = V.get(this);
        if (void 0 === s) return G.apply(this, t);
        const i = this.length;
        const n = 0 | e;
    ...
    sort: function(t) {
        ...
        const r = this.length;
        if (r < 2) return this;
        q(this, e.indexMap, 0, r, N);
        let s = 0;
        while (s < r) {
            if (void 0 === this[s]) break;
            s++;
        }
        if (void 0 === t || "function" !== typeof t) t = D;
        q(this, e.indexMap, 0, s, t);
        e.notify();
        return this;
    }
};

for (const t of Y) x(tt[t], "observing", {
    value: true,
    writable: false,
    configurable: false,
    enumerable: false
...
function rt() {
    for (const t of Y) if (true !== _[t].observing) m(_, t, tt[t]);
}

function st() {
    for (const t of Y) if (true === _[t].observing) m(_, t, X[t]);
}
...
for (const t of dt) x(pt[t], "observing", {
    value: true,
    writable: false,
    configurable: false,
    enumerable: false
...
function bt() {
    for (const t of dt) if (true !== ut[t].observing) x(ut, t, {
        ...vt,
        value: pt[t]
    });
}
...
for (const t of Ct) x(St[t], "observing", {
    value: true,
    writable: false,
    configurable: false,
    enumerable: false
...
function Lt() {
    for (const t of Ct) if (true !== Et[t].observing) x(Et, t, {
        ...Bt,
        value: St[t]
    });
}
...
function Rt() {
    return m(this, "obs", new BindingObserverRecord(this));
}

function jt(t) {
    let e;
    if (t instanceof Array) e = it(t); else if (t instanceof Set) e = xt(t); else if (t instanceof Map) e = Pt(t); else throw new Error("AUR0210");
    this.obs.add(e);
}
...
function Vt(t) {
    const e = t.prototype;
    E(e, "observe", Tt, true);
    E(e, "observeCollection", jt, true);
    E(e, "subscribeTo", It, true);
    x(e, "obs", {
        get: Rt
    });
    E(e, "handleChange", Mt);
    E(e, "handleCollectionChange", Ft);
    return t;
}

function Dt(t) {
    return null == t ? Vt : Vt(t);
}
...
class ExpressionParser {
    ...
    $parse(t, e) {
        ...
        Zt.index = 0;
        Zt.o = t.charCodeAt(0);
        return Xt(Zt, 0, 61, void 0 === e ? 53 : e);
    }
}
...
const _t = PrimitiveLiteralExpression.$false;
...
const Gt = AccessThisExpression.$parent;
...
function Xt(t, e, r, s) {
    ...
    if (32768 & t.l) {
        const r = de[63 & t.l];
        ie(t);
        i = new UnaryExpression(r, Xt(t, e, 449, s));
        t.m = false;
    } else {
        t: switch (t.l) {
          case 3078:
            ...
            do {
                ...
                if (le(t, 16393)) {
                    ...
                    const t = 511 & e;
                    i = 0 === t ? zt : 1 === t ? Gt : new AccessThisExpression(t);
                    e = 512;
                    break t;
        ...
        while ((16384 & t.l) > 0) {
            ...
            switch (t.l) {
              ...
              case 671757:
                ...
                ie(t);
                e = 4096;
                i = new AccessKeyedExpression(i, Xt(t, 0, 62, s));
                fe(t, 1835022);
                break;
    ...
    while ((65536 & t.l) > 0) {
        ...
        if ((448 & n) <= r) break;
        ie(t);
        i = new BinaryExpression(de[63 & n], i, Xt(t, e, 448 & n, s));
        t.m = false;
    }
    if (63 < r) return i;
    if (le(t, 1572880)) {
        const r = Xt(t, e, 62, s);
        fe(t, 1572879);
        i = new ConditionalExpression(i, r, Xt(t, e, 62, s));
        t.m = false;
    }
    if (62 < r) return i;
    if (le(t, 1048616)) {
        if (!t.m) throw new Error(`AUR0158:${t.ip}`);
        i = new AssignExpression(i, Xt(t, e, 62, s));
    }
    if (61 < r) return i;
    while (le(t, 1572884)) {
        ...
        ie(t);
        const n = new Array;
        while (le(t, 1572879)) n.push(Xt(t, e, 62, s));
...
function Yt(t, e, r) {
    ie(t);
    const s = new Array;
    while (1835022 !== t.l) if (le(t, 1572876)) {
        s.push(Wt);
        if (1835022 === t.l) break;
    } else {
        s.push(Xt(t, e, 62, ~512 & r));
        if (le(t, 1572876)) {
            if (1835022 === t.l) break;
        } else break;
    }
...
function ee(t, e) {
    ...
    while (1835018 !== t.l) {
        ...
        if (12288 & t.l) {
            ie(t);
            fe(t, 1572879);
            s.push(Xt(t, 0, 62, ~512 & e));
        } else if (3072 & t.l) {
            const {o: r, l: i, index: n} = t;
            ie(t);
            if (le(t, 1572879)) s.push(Xt(t, 0, 62, ~512 & e)); else {
                t.o = r;
                t.l = i;
                t.index = n;
                s.push(Xt(t, 0, 450, ~512 & e));
            }
        } else throw new Error(`AUR0164:${t.ip}`);
        if (1835018 !== t.l) fe(t, 1572876);
    }
    fe(t, 1835018);
...
function se(t, e, r, s, i) {
    const n = [ t.g ];
    fe(t, 540715);
    const o = [ Xt(t, e, 62, r) ];
    while (540714 !== (t.l = ae(t))) {
        n.push(t.g);
        fe(t, 540715);
        o.push(Xt(t, e, 62, r));
    }
...
function ce(t) {
    ...
    while (96 !== ne(t)) if (36 === t.o) if (t.index + 1 < t.length && 123 === t.ip.charCodeAt(t.index + 1)) {
        ...
        e = false;
        break;
    } else r += "$"; else if (92 === t.o) r += String.fromCharCode(Kt(ne(t))); else {
...
function fe(t, e) {
    if (t.l === e) ie(t); else throw new Error(`AUR0167:${t.ip}<${e}`);
}

const de = [ _t, Ht, Qt, Wt, "$this", null, "$parent", "(", "{", ".", "}", ")", ",", "[", "]", ":", "?", "'", '"', "&", "|", "||", "&&", "==", "!=", "===", "!==", "<", ">", "<=", ">=", "in", "instanceof", "+", "-", "typeof", "void", "*", "%", "/", "=", "!", 540714, 540715, "of" ];
...
ge(null, xe, ve.AsciiIdPart, true);

const me = new Uint8Array(65535);

ge(me, null, ve.IdStart, 1);

ge(me, null, ve.Digit, 1);

const Ee = new Array(65535);

Ee.fill(we, 0, 65535);

ge(Ee, null, ve.Skip, (t => {
    ne(t);
    return null;
}));

ge(Ee, null, ve.IdStart, oe);

ge(Ee, null, ve.Digit, (t => he(t, false)));
...
Ee[46] = t => {
    if (ne(t) <= 57 && t.o >= 48) return he(t, true);
    return 16393;
};
...
function Be(t) {
    ...
    if (ye === t) throw new Error("AUR0207");
    Ae.push(ye);
    ye = t;
    Ue = true;
}
...
function $e(t) {
    ...
    if (ye !== t) throw new Error("AUR0209");
    Ae.pop();
    ye = Ae.length > 0 ? Ae[Ae.length - 1] : null;
    Ue = null != ye;
}
...
function Ne(t) {
    const e = t instanceof Array ? qe : t instanceof Map || t instanceof Set ? fr : Ke;
...
const Ke = {
    get(t, e, r) {
        if (e === je) return t;
        const s = Se();
        if (!Ue || De(e) || null == s) return ke(t, e, r);
        s.observe(t, e);
        return Ie(ke(t, e, r));
    }
};
...
const qe = {
    ...
    ownKeys(t) {
        var e;
        null === (e = Se()) || void 0 === e ? void 0 : e.observe(t, "length");
...
function _e(t, e) {
    var r;
    const s = Fe(this);
    const i = s.map(((r, s) => Ve(t.call(e, Ie(r), s, this))));
    null === (r = Se()) || void 0 === r ? void 0 : r.observeCollection(s);
    return Ie(i);
}
...
function Qe(t, e) {
    var r;
    const s = Fe(this);
    const i = s.filter(((r, s) => Ve(t.call(e, Ie(r), s, this))));
    null === (r = Se()) || void 0 === r ? void 0 : r.observeCollection(s);
    return Ie(i);
}
...
function We(t) {
    var e;
    const r = Fe(this);
    const s = r.includes(Ve(t));
    null === (e = Se()) || void 0 === e ? void 0 : e.observeCollection(r);
    return s;
}
...
function Ze(t, e) {
    var r;
    const s = Fe(this);
    const i = s.findIndex(((r, s) => Ve(t.call(e, Ie(r), s, this))));
    null === (r = Se()) || void 0 === r ? void 0 : r.observeCollection(s);
    return i;
}
...
function Xe() {
    var t;
    const e = Fe(this);
    null === (t = Se()) || void 0 === t ? void 0 : t.observeCollection(e);
    return Ie(e.flat());
}
...
function hr(t, e) {
    var r;
    const s = Fe(this);
    const i = s.some(((r, s) => Ve(t.call(e, Ie(r), s, this))));
    null === (r = Se()) || void 0 === r ? void 0 : r.observeCollection(s);
    return i;
}
...
function vr(t) {
    ...
    const r = Fe(this);
    null === (e = Se()) || void 0 === e ? void 0 : e.observeCollection(r);
    return Ie(r.get(Ve(t)));
}

function gr(t, e) {
    return Ie(Fe(this).set(Ve(t), Ve(e)));
}

function br(t) {
    return Ie(Fe(this).add(Ve(t)));
}

function wr() {
    return Ie(Fe(this).clear());
}

function xr(t) {
    return Ie(Fe(this).delete(Ve(t)));
}
...
class ComputedObserver {
    ...
    flush() {
        Ur = this.U;
        this.U = this.value;
        this.subs.notify(this.value, Ur, 0);
    }
    run() {
    ...
    compute() {
        ...
        try {
            Be(this);
            return this.value = Ve(this.get.call(this.useProxy ? Ie(this.obj) : this.obj, this));
        } finally {
...
const Or = t.DI.createInterface("IDirtyChecker", (t => t.singleton(DirtyChecker)));
...
class DirtyChecker {
    constructor(t) {
        ...
        this.check = () => {
            ...
            if (++this.S < Cr.timeoutsPerCheck) return;
            this.S = 0;
    ...
    addProperty(t) {
        this.tracked.push(t);
        if (1 === this.tracked.length) this.C = this.p.taskQueue.queueTask(this.check, Sr);
    }
    removeProperty(t) {
...
class SetterObserver {
    ...
    flush() {
        Br = this.oldValue;
        this.oldValue = this.value;
        this.subs.notify(this.value, Br, this.f);
    }
    start() {
        if (false === this.observing) {
            this.observing = true;
            this.value = this.obj[this.propertyKey];
            x(this.obj, this.propertyKey, {
                enumerable: true,
                configurable: true,
                get: () => this.getValue(),
                set: t => {
...
const $r = new PropertyAccessor;

const Lr = t.DI.createInterface("IObserverLocator", (t => t.singleton(ObserverLocator)));

const kr = t.DI.createInterface("INodeObserverLocator", (e => e.cachedCallback((e => {
...
class ObserverLocator {
    ...
    getObserver(t, e) {
        var r, s;
        return null !== (s = null === (r = t.$observers) || void 0 === r ? void 0 : r[e]) && void 0 !== s ? s : this.k(t, e, this.createObserver(t, e));
    }
    getAccessor(t, e) {
        var r;
    ...
    createObserver(e, r) {
        ...
        if (this.$.handles(e, r, this)) return this.$.getObserver(e, r, this);
        switch (r) {
          case "length":
            if (e instanceof Array) return it(e).getLengthObserver();
            break;

          case "size":
            if (e instanceof Map) return Pt(e).getLengthObserver(); else if (e instanceof Set) return xt(e).getLengthObserver();
            break;

          default:
            if (e instanceof Array && t.isArrayIndex(r)) return it(e).getIndexObserver(Number(r));
            break;
        }
        let h = Rr(e, r);
        if (void 0 === h) {
            ...
            while (null !== t) {
                h = Rr(t, r);
                if (void 0 === h) t = Tr(t); else break;
            }
        }
        if (void 0 !== h && !w.call(h, "value")) {
            let t = this.P(e, r, h);
            ...
            return null == t ? h.configurable ? ComputedObserver.create(e, r, h, this, true) : this.B.createProperty(e, r) : t;
        }
...
ObserverLocator.inject = [ Or, kr ];

function Pr(t) {
    let e;
    if (t instanceof Array) e = it(t); else if (t instanceof Map) e = Pt(t); else if (t instanceof Set) e = xt(t);
    return e;
}

const Tr = Object.getPrototypeOf;

const Rr = Object.getOwnPropertyDescriptor;

const jr = t.DI.createInterface("IObservation", (t => t.singleton(Observation)));
...
function Ir(t) {
    if (void 0 === t.$observers) x(t, "$observers", {
        value: {}
    });
    return t.$observers;
}
...
function Fr(t, e, r) {
    ...
    function s(t, e, r, s) {
        ...
        r.get = function t() {
            var r;
            const s = Vr(this, e, o, h, u);
            null === (r = Se()) || void 0 === r ? void 0 : r.subscribeTo(s);
            return s.getValue();
        };
        r.set = function t(r) {
            Vr(this, e, o, h, u).setValue(r, 0);
        };
        r.get.getObserver = function t(r) {
            return Vr(r, e, o, h, u);
        };
        if (n) x(t.prototype, e, r); else return r;
    }
}

function Vr(t, e, r, s, i) {
    const n = Ir(t);
    let o = n[e];
    if (null == o) {
        o = new SetterNotifier(t, r, i, s === Mr ? void 0 : s);
        n[e] = o;
    }
    return o;
}
...
exports.ConnectableSwitcher = Le;
...
exports.IDirtyChecker = Or;

exports.IExpressionParser = Nt;

exports.INodeObserverLocator = kr;

exports.IObservation = jr;

exports.IObserverLocator = Lr;
...
exports.applyMutationsToIndices = nt;

exports.bindingBehavior = o;

exports.cloneIndexMap = O;

exports.connectable = Dt;

exports.copyIndexMap = A;

exports.createIndexMap = U;

exports.disableArrayObservation = st;
...
exports.enableMapObservation = Lt;

exports.enableSetObservation = bt;

exports.getCollectionObserver = Pr;

exports.isIndexMap = C;

exports.observable = Fr;

exports.parse = Xt;

exports.parseExpression = Jt;

exports.registerAliases = s;

exports.subscriberCollection = S;

exports.synchronizeIndices = ot;

exports.valueConverter = c;

exports.withFlushQueue = P;
