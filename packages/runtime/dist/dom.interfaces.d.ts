...
export declare type IShadowRootMode = 'open' | 'closed';
...
export declare type IInsertPosition = 'beforebegin' | 'afterbegin' | 'beforeend' | 'afterend';
...
export declare type IMutationRecordType = 'attributes' | 'characterData' | 'childList';
...
export interface IDocument extends INode, IDocumentOrShadowRoot, IParentNode {
    ...
    createElement<T extends IHTMLElement, TTag extends string>(tagName: TTag): TTag extends 'template' ? IHTMLTemplateElement : TTag extends 'slot' ? IHTMLSlotElement : T;
...
export {};
//# sourceMappingURL=dom.interfaces.d.ts.map