...
export declare class TextBindingRenderer implements IInstructionRenderer {
    ...
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: INode, instruction: ITextBindingInstruction): void;
}
...
export declare class ListenerBindingRenderer implements IInstructionRenderer {
    ...
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: INode, instruction: IListenerBindingInstruction): void;
}
...
export declare class StylePropertyBindingRenderer implements IInstructionRenderer {
    ...
    private observerLocator;
    constructor(parser: IExpressionParser, observerLocator: IObserverLocator);
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IHTMLElement, instruction: IStylePropertyBindingInstruction): void;
}
export declare class SetPropertyRenderer implements IInstructionRenderer {
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IIndexable, instruction: ISetPropertyInstruction): void;
}
export declare class SetAttributeRenderer implements IInstructionRenderer {
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IElement, instruction: ISetAttributeInstruction): void;
}
export declare class CustomElementRenderer implements IInstructionRenderer {
    ...
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IRenderLocation, instruction: IHydrateElementInstruction): void;
}
export declare class CustomAttributeRenderer implements IInstructionRenderer {
    private renderingEngine;
    constructor(renderingEngine: IRenderingEngine);
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IElement, instruction: IHydrateAttributeInstruction): void;
}
export declare class TemplateControllerRenderer implements IInstructionRenderer {
    private renderingEngine;
    constructor(renderingEngine: IRenderingEngine);
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IElement, instruction: IHydrateTemplateController, parts?: TemplatePartDefinitions): void;
}
export declare class LetElementRenderer implements IInstructionRenderer {
    private parser;
    private observerLocator;
    constructor(parser: IExpressionParser, observerLocator: IObserverLocator);
    render(dom: IDOM, context: IRenderContext, renderable: IRenderable, target: IElement, instruction: IHydrateLetElementInstruction): void;
}
