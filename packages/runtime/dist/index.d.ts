...
export { DOM, INode, IRenderLocation, IDOM, NodeSequence, INodeSequence, INodeSequenceFactory } from './dom';
...
export { AggregateLifecycleTask, CompositionCoordinator, IComponent, IBinding, ILifecycle, ILifecycleHooks, IMountableComponent, ILifecycleTask, IRenderable, IRenderContext, IState, IView, IViewCache, IViewFactory, LifecycleTask, PromiseTask } from './lifecycle';
