...
export { bindingBehavior, BindingBehavior, IBindingBehavior, IBindingBehaviorDefinition, IBindingBehaviorResource, IBindingBehaviorType } from './resources/binding-behavior';
...
export { customAttribute, CustomAttributeConstructor, CustomAttributeDecorator, CustomAttribute, dynamicOptions, ICustomAttributeResource, ICustomAttributeType, templateController } from './resources/custom-attribute';
...
export { containerless, customElement, CustomElementHost, CustomElement, ICustomElementDecorator, ICustomElementResource, ICustomElementType, IElementProjector, IProjectorLocator, useShadowDOM } from './resources/custom-element';
