...
export { IObjectObservationAdapter, IObserverLocator, ITargetObserverLocator, ITargetAccessorLocator, getCollectionObserver, ObserverLocator } from './observation/observer-locator';
...
export { customAttribute, CustomAttributeConstructor, CustomAttributeDecorator, CustomAttributeResource, dynamicOptions, ICustomAttributeResource, ICustomAttributeType, templateController } from './resources/custom-attribute';
...
export { containerless, customElement, CustomElementHost, CustomElementResource, ICustomElementDecorator, ICustomElementResource, ICustomElementType, IElementProjector, IProjectorLocator, useShadowDOM } from './resources/custom-element';
