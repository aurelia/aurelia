  ...
  return {
    ...
    execute: function () {
      ...
      ***************************************************************************** */
      ...
      })(MutationKind || (MutationKind = exports('MutationKind', {})));
      var CollectionKind;
      ...
      */
      ...
      const IRenderable = exports('IRenderable', DI.createInterface('IRenderable').noDefault());
      ...
      const KeyedBindingBehaviorRegistration = exports('KeyedBindingBehaviorRegistration', KeyedBindingBehavior);
