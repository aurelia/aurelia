System.register('runtime', ['@aurelia/kernel'], function (exports) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports({
                BindingMode: void 0,
                BindingStrategy: void 0,
                BindingType: void 0,
                CollectionKind: void 0,
                DelegationStrategy: void 0,
                ExpressionKind: void 0,
                Hooks: void 0,
                LifecycleFlags: void 0,
                Priority: void 0,
                State: void 0,
                TargetedInstructionType: void 0,
                ViewCompileFlags: void 0,
                ViewModelKind: void 0,
            ...
            ***************************************************************************** */
            ...
            let ProxyObserver = exports('ProxyObserver', ProxyObserver_1 = class ProxyObserver {
                constructor(obj) {
                    if (Tracer.enabled) {
            ...
            ProxyObserver = exports('ProxyObserver', ProxyObserver_1 = __decorate([
                proxySubscriberCollection()
            ], ProxyObserver));

            let SetterObserver = exports('SetterObserver', class SetterObserver {
            ...
            SetterObserver = exports('SetterObserver', __decorate([
                subscriberCollection()
            ], SetterObserver));
            ...
            const ISignaler = exports('ISignaler', DI.createInterface('ISignaler').withDefault(x => x.singleton(Signaler)));
            /** @internal */
            class Signaler {
                constructor() {
            ...
            const BindingBehaviorResource = exports('BindingBehaviorResource', {
            ...
            const ValueConverterResource = exports('ValueConverterResource', {
            ...
            */
            ...
            })(BindingMode || (BindingMode = exports('BindingMode', {})));
            var BindingStrategy;
            ...
            })(BindingStrategy || (BindingStrategy = exports('BindingStrategy', {})));
            ...
            })(ViewModelKind || (ViewModelKind = exports('ViewModelKind', {})));
            const IController = exports('IController', DI.createInterface('IController').noDefault());
            const IViewFactory = exports('IViewFactory', DI.createInterface('IViewFactory').noDefault());
            ...
            })(Priority || (Priority = exports('Priority', {})));
            const ILifecycle = exports('ILifecycle', DI.createInterface('ILifecycle').withDefault(x => x.singleton(Lifecycle)));
            const { min, max } = Math;
            class BoundQueue {
            ...
            let Binding = exports('Binding', class Binding {
            ...
            Binding = exports('Binding', __decorate([
                connectable()
            ], Binding));
            ...
            const IExpressionParser = exports('IExpressionParser', DI.createInterface('IExpressionParser').withDefault(x => x.singleton(ExpressionParser)));
            /** @internal */
            ...
            let InterpolationBinding = exports('InterpolationBinding', class InterpolationBinding {
            ...
            InterpolationBinding = exports('InterpolationBinding', __decorate([
                connectable()
            ], InterpolationBinding));

            const slice$5 = Array.prototype.slice;
            let LetBinding = exports('LetBinding', class LetBinding {
            ...
            LetBinding = exports('LetBinding', __decorate([
                connectable()
            ], LetBinding));
            ...
            })(DelegationStrategy || (DelegationStrategy = exports('DelegationStrategy', {})));
            var CollectionKind;
            ...
            })(CollectionKind || (CollectionKind = exports('CollectionKind', {})));
            ...
            let CollectionLengthObserver = exports('CollectionLengthObserver', class CollectionLengthObserver {
                constructor(obj) {
                    this.obj = obj;
            ...
            CollectionLengthObserver = exports('CollectionLengthObserver', __decorate([
                subscriberCollection()
            ...
            let ArrayObserver = exports('ArrayObserver', class ArrayObserver {
                constructor(flags, lifecycle, array) {
                    if (Tracer.enabled) {
                        Tracer.enter('ArrayObserver', 'constructor', slice$7.call(arguments));
                    }
            ...
            ArrayObserver = exports('ArrayObserver', __decorate([
            ...
            let CollectionSizeObserver = exports('CollectionSizeObserver', class CollectionSizeObserver {
                constructor(obj) {
                    this.obj = obj;
            ...
            CollectionSizeObserver = exports('CollectionSizeObserver', __decorate([
                subscriberCollection()
            ...
            let MapObserver = exports('MapObserver', class MapObserver {
                constructor(flags, lifecycle, map) {
                    if (Tracer.enabled) {
                        Tracer.enter('MapObserver', 'constructor', slice$8.call(arguments));
                    }
            ...
            MapObserver = exports('MapObserver', __decorate([
                collectionSubscriberCollection()
            ], MapObserver));
            ...
            let SetObserver = exports('SetObserver', class SetObserver {
                constructor(flags, lifecycle, observedSet) {
                    if (Tracer.enabled) {
                        Tracer.enter('SetObserver', 'constructor', slice$9.call(arguments));
                    }
            ...
            SetObserver = exports('SetObserver', __decorate([
                collectionSubscriberCollection()
            ], SetObserver));
            ...
            let CustomSetterObserver = exports('CustomSetterObserver', class CustomSetterObserver {
                ...
                setValue(newValue) {
                    if (Tracer.enabled) {
                        Tracer.enter('CustomSetterObserver', 'setValue', slice$a.call(arguments));
                    }
                ...
                convertProperty() {
                    if (Tracer.enabled) {
                        Tracer.enter('CustomSetterObserver', 'convertProperty', slice$a.call(arguments));
                    }
                    this.observing = true;
                    this.currentValue = this.obj[this.propertyKey];
            ...
            CustomSetterObserver = exports('CustomSetterObserver', __decorate([
                subscriberCollection()
            ], CustomSetterObserver));
            // Used when there is no setter, and the getter is dependent on other properties of the object;
            // Used when there is a setter but the value of the getter can change based on properties set outside of the setter.
            /** @internal */
            let GetterObserver = exports('GetterObserver', class GetterObserver {
                ...
                getValue() {
                    if (Tracer.enabled) {
                        Tracer.enter('GetterObserver', 'getValue', slice$a.call(arguments));
                    }
                ...
                getValueAndCollectDependencies(requireCollect) {
                    if (Tracer.enabled) {
                        Tracer.enter('GetterObserver', 'getValueAndCollectDependencies', slice$a.call(arguments));
                    }
            ...
            GetterObserver = exports('GetterObserver', __decorate([
                subscriberCollection()
            ], GetterObserver));
            const toStringTag$1 = Object.prototype.toString;
            function createGetterTraps(flags, observerLocator, observer) {
                if (Tracer.enabled) {
                    Tracer.enter('computed', 'createGetterTraps', slice$a.call(arguments));
                }
                const traps = {
                    get: function (target, key, receiver) {
                        if (Tracer.enabled) {
                            Tracer.enter('computed', 'get', slice$a.call(arguments));
                        }
            ...
            const IDirtyChecker = exports('IDirtyChecker', DI.createInterface('IDirtyChecker').withDefault(x => x.singleton(DirtyChecker)));
            const DirtyCheckSettings = exports('DirtyCheckSettings', {
                /**
                 * Default: `6`
                 *
            ...
            let DirtyCheckProperty = exports('DirtyCheckProperty', class DirtyCheckProperty {
                constructor(dirtyChecker, obj, propertyKey) {
                    if (Tracer.enabled) {
                        Tracer.enter('DirtyCheckProperty', 'constructor', slice$b.call(arguments));
                    }
                    this.obj = obj;
                    this.propertyKey = propertyKey;
            ...
            class PrimitiveObserver {
                constructor(obj, propertyKey) {
                    ...
                    if (Tracer.enabled) {
                        Tracer.enter('PrimitiveObserver', 'constructor', slice$c.call(arguments));
                    }
            ...
            class PropertyAccessor {
                constructor(obj, propertyKey) {
                    if (Tracer.enabled) {
                        Tracer.enter('PropertyAccessor', 'constructor', slice$d.call(arguments));
                    }
                    this.obj = obj;
                    this.propertyKey = propertyKey;
                    if (Tracer.enabled) {
            ...
            const IObserverLocator = exports('IObserverLocator', DI.createInterface('IObserverLocator').noDefault());
            const ITargetObserverLocator = exports('ITargetObserverLocator', DI.createInterface('ITargetObserverLocator').noDefault());
            const ITargetAccessorLocator = exports('ITargetAccessorLocator', DI.createInterface('ITargetAccessorLocator').noDefault());
            ...
            var SelfObserver_1;
            let SelfObserver = exports('SelfObserver', SelfObserver_1 = class SelfObserver {
            ...
            SelfObserver = exports('SelfObserver', SelfObserver_1 = __decorate([
                subscriberCollection()
            ], SelfObserver));
            ...
            const Bindable = exports('Bindable', {
                for(obj) {
                    const builder = {
                        add(nameOrConfig) {
            ...
            })(TargetedInstructionType || (TargetedInstructionType = exports('TargetedInstructionType', {})));
            const ITargetedInstruction = exports('ITargetedInstruction', DI.createInterface('createInterface').noDefault());
            ...
            const CustomAttributeResource = exports('CustomAttributeResource', {
            ...
            const NodeSequence = exports('NodeSequence', {
                empty: emptySequence
            });

            const LifecycleTask = exports('LifecycleTask', {
                done: {
                    done: true,
            ...
            const IProjectorLocator = exports('IProjectorLocator', DI.createInterface('IProjectorLocator').noDefault());
            /** @internal */
            ...
            const CustomElementResource = exports('CustomElementResource', {
            ...
            const ISanitizer = exports('ISanitizer', DI.createInterface('ISanitizer').withDefault(x => x.singleton(class {
                sanitize(input) {
            ...
            const ITemplateCompiler = exports('ITemplateCompiler', DI.createInterface('ITemplateCompiler').noDefault());
            ...
            })(ViewCompileFlags || (ViewCompileFlags = exports('ViewCompileFlags', {})));
            const ITemplateFactory = exports('ITemplateFactory', DI.createInterface('ITemplateFactory').noDefault());
            ...
            const IInstructionRenderer = exports('IInstructionRenderer', DI.createInterface('IInstructionRenderer').noDefault());
            const IRenderer = exports('IRenderer', DI.createInterface('IRenderer').noDefault());
            const IRenderingEngine = exports('IRenderingEngine', DI.createInterface('IRenderingEngine').withDefault(x => x.singleton(RenderingEngine)));
            /** @internal */
            ...
            const IDOMInitializer = exports('IDOMInitializer', DI.createInterface('IDOMInitializer').noDefault());
            ...
            function addBinding(renderable, binding) {
                if (Tracer.enabled) {
                    Tracer.enter('Renderer', 'addBinding', slice$e.call(arguments));
                }
            ...
            function addComponent(renderable, component) {
                if (Tracer.enabled) {
                    Tracer.enter('Renderer', 'addComponent', slice$e.call(arguments));
                }
            ...
            class SetPropertyRenderer {
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('SetPropertyRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class CustomElementRenderer {
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('CustomElementRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class CustomAttributeRenderer {
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('CustomAttributeRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class TemplateControllerRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction, parts) {
                    if (Tracer.enabled) {
                        Tracer.enter('TemplateControllerRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class LetElementRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('LetElementRenderer', 'render', slice$e.call(arguments));
                    }
                    dom.remove(target);
                    const childInstructions = instruction.instructions;
            ...
            class CallBindingRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('CallBindingRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class RefBindingRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('RefBindingRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class InterpolationBindingRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('InterpolationBindingRenderer', 'render', slice$e.call(arguments));
                    }
                    let binding;
            ...
            class PropertyBindingRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('PropertyBindingRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            class IteratorBindingRenderer {
                ...
                render(flags, dom, context, renderable, target, instruction) {
                    if (Tracer.enabled) {
                        Tracer.enter('IteratorBindingRenderer', 'render', slice$e.call(arguments));
                    }
            ...
            const IObserverLocatorRegistration = exports('IObserverLocatorRegistration', ObserverLocator);
            const ILifecycleRegistration = exports('ILifecycleRegistration', Lifecycle);
            const IRendererRegistration = exports('IRendererRegistration', Renderer);
            /**
            ...
            const PriorityBindingBehaviorRegistration = exports('PriorityBindingBehaviorRegistration', PriorityBindingBehavior);
            /**
             * Default resources:
            ...
            const CallBindingRendererRegistration = exports('CallBindingRendererRegistration', CallBindingRenderer);
            const CustomAttributeRendererRegistration = exports('CustomAttributeRendererRegistration', CustomAttributeRenderer);
            const CustomElementRendererRegistration = exports('CustomElementRendererRegistration', CustomElementRenderer);
            const InterpolationBindingRendererRegistration = exports('InterpolationBindingRendererRegistration', InterpolationBindingRenderer);
            const IteratorBindingRendererRegistration = exports('IteratorBindingRendererRegistration', IteratorBindingRenderer);
            const LetElementRendererRegistration = exports('LetElementRendererRegistration', LetElementRenderer);
            const PropertyBindingRendererRegistration = exports('PropertyBindingRendererRegistration', PropertyBindingRenderer);
            const RefBindingRendererRegistration = exports('RefBindingRendererRegistration', RefBindingRenderer);
            const SetPropertyRendererRegistration = exports('SetPropertyRendererRegistration', SetPropertyRenderer);
            const TemplateControllerRendererRegistration = exports('TemplateControllerRendererRegistration', TemplateControllerRenderer);
            /**
             ...
             * - `DefaultRenderers`
             */
            const RuntimeBasicConfiguration = exports('RuntimeBasicConfiguration', {
                /**
