...
import { DI, isObjectOrFunction, isFunction, isArray, isArrayIndex, isSet, isMap, areEqual, Registration, resolve, IPlatform, ILogger, isObject, createLookup, emptyObject } from '../../../kernel/dist/native-modules/index.mjs';
