...
import { Collection, CollectionKind, IBindingTargetObserver, IPatchable, IPropertySubscriber } from '../observation';
...
export declare class CollectionLengthObserver implements CollectionLengthObserver, IPatchable {
    currentValue: number;
    obj: Collection;
