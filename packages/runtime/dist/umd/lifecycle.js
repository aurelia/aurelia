(function (factory) {
    ...
    class Lifecycle {
            ...
            this.tick = (timestamp) => {
                ...
                if (this.isTicking) {
                    ...
                    if (this.isTicking && this.rafRequestId === -1 && this.rafHead.next !== void 0) {
                        this.rafRequestId = kernel_1.PLATFORM.requestAnimationFrame(this.tick);
                    }
        ...
        startTicking() {
            if (!this.isTicking) {
                ...
                if (this.rafRequestId === -1 && this.rafHead.next !== void 0) {
                    this.rafStartTime = kernel_1.PLATFORM.now();
                    this.rafRequestId = kernel_1.PLATFORM.requestAnimationFrame(this.tick);
                }
            }
        ...
        stopTicking() {
            ...
            if (this.isTicking) {
                ...
                if (this.rafRequestId !== -1) {
                    kernel_1.PLATFORM.cancelAnimationFrame(this.rafRequestId);
                    this.rafRequestId = -1;
                }
            }
        ...
        processRAFQueue(flags, timestamp = kernel_1.PLATFORM.now()) {
                    ...
                    while (current !== void 0) {
                        ...
                        if (++i === 10) {
                            ...
                            if (this.timeslicingEnabled) {
                                ...
                                const now = kernel_1.PLATFORM.now();
