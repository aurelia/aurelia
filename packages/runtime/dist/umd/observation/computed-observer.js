    ...
    let GetterObserver = class GetterObserver {
        ...
        getValue() {
            if (this.subscriberCount > 0 || this.isCollecting) {
                ...
                this.currentValue = Reflect.apply(this.descriptor.get, this.proxy, kernel_1.emptyArray); // Non-null is implied because descriptors without getters won't end up here
            }
            else {
                // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                this.currentValue = Reflect.apply(this.descriptor.get, this.obj, kernel_1.emptyArray); // Non-null is implied because descriptors without getters won't end up here
            }
