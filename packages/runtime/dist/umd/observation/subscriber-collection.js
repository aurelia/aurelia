(function (factory) {
    ...
    exports.SubscriberRecord = exports.collectionSubscriberCollection = exports.subscriberCollection = void 0;
    ...
    function collectionSubscriberCollection() {
        ...
        return function (target) {
            const proto = target.prototype;
            utilities_objects_js_1.ensureProto(proto, 'addCollectionSubscriber', addSubscriber, true);
            utilities_objects_js_1.ensureProto(proto, 'removeCollectionSubscriber', removeSubscriber, true);
            utilities_objects_js_1.ensureProto(proto, 'hasCollectionSubscriber', hasSubscriber, true);
            utilities_objects_js_1.ensureProto(proto, 'hasCollectionSubscribers', hasSubscribers, true);
            utilities_objects_js_1.ensureProto(proto, 'callCollectionSubscribers', callCollectionSubscribers, true);
            // not configurable, as in devtool, the getter could be invoked on the prototype,
            // and become permanently broken
            utilities_objects_js_1.def(proto, 'subs', { get: getSubscriberRecord });
            utilities_objects_js_1.ensureProto(proto, 'subscribeToCollection', addSubscriber);
            utilities_objects_js_1.ensureProto(proto, 'unsubscribeFromCollection', removeSubscriber);
        };
    }
