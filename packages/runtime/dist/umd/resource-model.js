(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "./binding-command", "./flags", "./resources/custom-attribute", "./resources/custom-element"], factory);
    }
    ...
    class ElementInfo {
        ...
        static from(def) {
            ...
            const defaultBindingMode = flags_1.BindingMode.toView;
            let bindable;
            let prop;
            let attr;
            let mode;
            for (prop in bindables) {
                ...
                if (bindable.mode !== void 0 && bindable.mode !== flags_1.BindingMode.default) {
                    mode = bindable.mode;
                }
                else {
    ...
    class AttrInfo {
        ...
        static from(def) {
            ...
            const bindables = def.bindables;
            const defaultBindingMode = def.defaultBindingMode !== void 0 && def.defaultBindingMode !== flags_1.BindingMode.default
                ? def.defaultBindingMode
                : flags_1.BindingMode.toView;
            let bindable;
            let prop;
            let mode;
    ...
    class ResourceModel {
        ...
        getElementInfo(name) {
            ...
            if (result === void 0) {
                const def = this.find(custom_element_1.CustomElement, name);
        ...
        getAttributeInfo(syntax) {
            ...
            if (result === void 0) {
                const def = this.find(custom_attribute_1.CustomAttribute, syntax.target);
