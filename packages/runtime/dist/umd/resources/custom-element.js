    ...
    class CustomElementDefinition {
        ...
        static create(nameOrDef, Type = null) {
            ...
            if (typeof nameOrDef === 'string') {
                ...
                kernel_1.fromAnnotationOrTypeOrDefault('hooks', Type, () => new definitions_1.HooksDefinition(Type.prototype)), kernel_1.mergeArrays(exports.CustomElement.getAnnotation(Type, 'scopeParts'), Type.scopeParts), kernel_1.fromAnnotationOrTypeOrDefault('enhance', Type, () => false));
            }
            ...
            // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
            kernel_1.fromAnnotationOrTypeOrDefault('hooks', Type, () => new definitions_1.HooksDefinition(Type.prototype)), kernel_1.mergeArrays(exports.CustomElement.getAnnotation(Type, 'scopeParts'), nameOrDef.scopeParts, Type.scopeParts), kernel_1.fromAnnotationOrDefinitionOrTypeOrDefault('enhance', nameOrDef, Type, () => false));
        }
