...
export interface IExpression {
  ...
  connect(flags: LifecycleFlags, scope: IScope, binding: IConnectable, hostScope?: IScope | null, part?: string, projection?: CustomElementDefinition): void;
  evaluate(flags: LifecycleFlags, scope: IScope, locator: IServiceLocator | null, hostScope?: IScope | null, part?: string, projection?: CustomElementDefinition): unknown;
  assign?(flags: LifecycleFlags, scope: IScope, locator: IServiceLocator | null, value: unknown, hostScope?: IScope | null, part?: string, projection?: CustomElementDefinition): unknown;
...
export interface IBindingBehaviorExpression extends IExpression {
  ...
  assign(flags: LifecycleFlags, scope: IScope, locator: IServiceLocator, value: unknown, hostScope?: IScope | null, part?: string, projection?: CustomElementDefinition): unknown;
  bind(flags: LifecycleFlags, scope: IScope, binding: IConnectable): void;
  unbind(flags: LifecycleFlags, scope: IScope, binding: IConnectable): void;
}
