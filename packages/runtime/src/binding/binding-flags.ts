export enum BindingFlags {
   ...
   */
  mustEvaluate        = 0b0000000000000000000000000000001,
  /**
   * Indicates that the change was batched and originates from flushChanges(), meaning batching can be skipped on nested callbacks
   */
  fromFlushChanges    = 0b0000000000000000000000000000010,
  /**
   ...
   */
  startTaskOrigin     = 0b0000000000000000000000000000100,
  /**
   ...
   */
  stopTaskOrigin      = 0b0000000000000000000000000001000,
  /**
   ...
   */
  bindOrigin          = 0b0000000000000000000000000010000,
  /**
   * The invocation originates from a custom element/attribute's $unbind
   *
   */
  unbindOrigin        = 0b0000000000000000000000000100000,
  /**
   ...
   */
  callbackOrigin      = 0b0000000000000000000000001000000,
  /**
   ...
   */
  sourceOrigin        = 0b0000000000000000000000010000000,
  /**
   ...
   */
  targetOrigin        = 0b0000000000000000000000100000000,
  origin              = 0b0000000000000000000000111111100
}
