...
import { UiEntry, UiCheckbox } from 'libui-napi';
import { ILibUiNode } from '../libui-dom';

const handleEventFlags = LifecycleFlags.fromDOMEvent | LifecycleFlags.updateSourceExpression;

export interface LibUiEntryObserver extends
  IBindingTargetObserver<ILibUiNode, string, Primitive | IIndexable> { }

@targetObserver('')
export class LibUiEntryObserver implements LibUiEntryObserver {
  ...
  constructor(
    ...
    this.oldValue = this.currentValue = obj.text;
  ...
  public subscribe(subscriber: IPropertySubscriber): void {
    if (!this.hasSubscribers()) {
      ...
      this.obj.onChanged(this.handleEvent);
    }
...
export interface LibUiCheckedObserver extends
  IBindingTargetObserver<UiCheckbox, string, Primitive | IIndexable>,
  IBatchedCollectionSubscriber,
  IPropertySubscriber { }

@targetObserver()
export class LibUiCheckedObserver implements LibUiCheckedObserver {
  public currentValue: Primitive | IIndexable;
  public currentFlags: LifecycleFlags;
  public oldValue: Primitive | IIndexable;
  public defaultValue: Primitive | IIndexable;
  ...
  private valueObserver: LibUiEntryObserver | SetterObserver;

  constructor(
    public lifecycle: ILifecycle,
    public obj: UiCheckbox,
...
LibUiCheckedObserver.prototype.observerLocator = null;
