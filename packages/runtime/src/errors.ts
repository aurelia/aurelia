...
export const enum ErrorNames {
  ...
  ast_track_decorator_not_a_method = 117,
...
const errorsMap: Record<ErrorNames, string> = {
  ...
  [ErrorNames.ast_track_decorator_not_a_method]: `The @astTrack decorator can only be applied to methods, "{{0}}" is not a method.`,
