...
export const enum LifecycleFlags {
  ...
  persistentBindingFlags        = 0b11111_00_00_00_111,
  allowParentScopeTraversal     = 0b00001_00_00_00_000,
  observeLeafPropertiesOnly     = 0b00010_00_00_00_000,
  targetObserverFlags           = 0b01100_00_00_00_111,
  noTargetObserverQueue         = 0b00100_00_00_00_000,
  persistentTargetObserverQueue = 0b01000_00_00_00_000,
  secondaryExpression           = 0b10000_00_00_00_000,
  bindingStrategy               = 0b00000_00_00_00_111,
  getterSetterStrategy          = 0b00000_00_00_00_001,
  proxyStrategy                 = 0b00000_00_00_00_010,
  isStrictBindingStrategy       = 0b00000_00_00_00_100,
  update                        = 0b00000_00_00_11_000,
  updateTargetInstance          = 0b00000_00_00_01_000,
  updateSourceExpression        = 0b00000_00_00_10_000,
  from                          = 0b00000_00_11_00_000,
  fromBind                      = 0b00000_00_01_00_000,
  fromUnbind                    = 0b00000_00_10_00_000,
  mustEvaluate                  = 0b00000_01_00_00_000,
  isTraversingParentScope       = 0b00000_10_00_00_000,
}
