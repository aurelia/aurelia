...
export * from './binding/class-observer';
export * from './binding/collection-observation'; // TODO: remove
...
export * from './templating/resources/repeat/override-contexts'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-array'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-map'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-null'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-number'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-registry'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy-set'; // TODO: remove
export * from './templating/resources/repeat/repeat-strategy'; // TODO: remove
export * from './templating/resources/repeat/repeat'; // TODO: remove
export * from './templating/resources/repeat/repeater'; // TODO: remove

export * from './templating/resources/compose';
export * from './templating/resources/else';
export * from './templating/resources/if-core';
export * from './templating/resources/if';
export * from './templating/resources/repeater';
export * from './templating/resources/replaceable';
export * from './templating/resources/with';

export * from './templating/animator';
