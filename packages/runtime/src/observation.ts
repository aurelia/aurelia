...
export const enum LifecycleFlags {
  ...
  persistentBindingFlags        = 0b1111_000_00_111,
  allowParentScopeTraversal     = 0b0001_000_00_000,
  observeLeafPropertiesOnly     = 0b0010_000_00_000,
  targetObserverFlags           = 0b1100_000_00_111,
  noFlush                       = 0b0100_000_00_000,
  persistentTargetObserverQueue = 0b1000_000_00_000,
  bindingStrategy               = 0b0000_000_00_111,
  getterSetterStrategy          = 0b0000_000_00_001,
  proxyStrategy                 = 0b0000_000_00_010,
  isStrictBindingStrategy       = 0b0000_000_00_100,
  from                          = 0b0000_000_11_000,
  fromBind                      = 0b0000_000_01_000,
  fromUnbind                    = 0b0000_000_10_000,
  mustEvaluate                  = 0b0000_001_00_000,
  isTraversingParentScope       = 0b0000_010_00_000,
  dispose                       = 0b0000_100_00_000,
}
