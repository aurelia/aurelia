...
import { ILibUiNode, ILibUiRenderLocation, ILibUiNodeSequence, LibUiControlSequenceFactory, ILibUiControlSequenceFactory, LibUiNodeSequence } from '../libui-dom';
...
export interface ICustomElementHost extends ILibUiRenderLocation {
...
export interface IElementProjector {
  ...
  project(nodes: ILibUiNodeSequence): void;
  take(nodes: ILibUiNodeSequence): void;
...
export interface ILifecycleRender {
   ...
   */
  render?(host: ILibUiNode, parts: Immutable<Pick<IHydrateElementInstruction, 'parts'>>): IElementTemplateProvider | void;
}
...
/*@internal*/
export function $hydrateElement(this: Writable<ICustomElement>, renderingEngine: IRenderingEngine, host: ILibUiNode, options: IElementHydrationOptions = PLATFORM.emptyObject): void {
  const Type = this.constructor as ICustomElementType;
  const description = Type.description;

  this.$scope = Scope.create(this, null);
  // This is quite an incorrect cast for libui
  // UiWindow is not UiControl subclass
...
export class HostProjector implements IElementProjector {
  ...
  get children(): ArrayLike<ILibUiNode & ICustomElementHost> {
  ...
  public provideEncapsulationSource(parentEncapsulationSource: ILibUiNode): ICustomElementHost {
    return (parentEncapsulationSource as ICustomElementHost) || this.host;
  }

  public project(nodes: ILibUiNodeSequence): void {
  ...
  public take(nodes: ILibUiNodeSequence): void {
...
export interface ITemplate {
  ...
  render(renderable: IRenderable, host?: ILibUiNode, parts?: TemplatePartDefinitions): void;
}
...
export class CompiledTemplate implements ITemplate {
  public readonly factory: ILibUiControlSequenceFactory;
  ...
  constructor(renderingEngine: IRenderingEngine, parentRenderContext: IRenderContext, private templateDefinition: TemplateDefinition) {
    this.factory = LibUiControlSequenceFactory.createFor(templateDefinition.template);
    this.renderContext = createRenderContext(renderingEngine, parentRenderContext, templateDefinition.dependencies);
  }

  public render(renderable: IRenderable, host?: ILibUiNode, parts?: TemplatePartDefinitions): void {
...
export const noViewTemplate: ITemplate = {
  ...
  render(renderable: IRenderable): void {
    (<Writable<IRenderable>>renderable).$nodes = LibUiNodeSequence.empty;
...
export function createRenderContext(renderingEngine: IRenderingEngine, parentRenderContext: IRenderContext, dependencies: ImmutableArray<IRegistry>): IRenderContext {
  ...
  const renderLocationProvider = new InstanceProvider<ILibUiRenderLocation>();
  ...
  context.registerResolver(ILibUiRenderLocation as any, renderLocationProvider);

  if (dependencies) {
    context.register(...dependencies);
  }

  context.render = function(this: IRenderContext, renderable: IRenderable, targets: ArrayLike<ILibUiNode>, templateDefinition: TemplateDefinition, host?: ILibUiNode, parts?: TemplatePartDefinitions): void {
    renderer.render(this, renderable, targets, templateDefinition, host, parts);
  };

  context.beginComponentOperation = function(renderable: IRenderable, target: ILibUiNode, instruction: ITargetedInstruction, factory?: IViewFactory, parts?: TemplatePartDefinitions, location?: ILibUiRenderLocation): IDisposable {
...
export interface IRenderer {
  ...
  render(context: IRenderContext, renderable: IRenderable, targets: ArrayLike<ILibUiNode>, templateDefinition: TemplateDefinition, host?: ILibUiNode, parts?: TemplatePartDefinitions): void;
}
...
export class Renderer implements IRenderer {
  ...
  public render(context: IRenderContext, renderable: IRenderable, targets: ArrayLike<ILibUiNode>, definition: TemplateDefinition, host?: ILibUiNode, parts?: TemplatePartDefinitions): void {
