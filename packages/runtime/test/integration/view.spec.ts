...
//     [string, View, ITemplate, ViewFactory, ILifecycle, boolean],
//     [string, LifecycleFlags, IScope],
//     [string, (sut: View) => void],
//     [string, IRenderLocation],
//     [string, (sut: View) => void],
//     [string, INode, ILifecycleController],
//     [string, (sut: View) => void],
//     [string, (sut: View) => void],
//     [string, ILifecycleController],
//     [string, (sut: View) => void],
...
//           return [` noViewTemplate, viewFactory(cache=true )`, <View>factory.create(), noViewTemplate, factory, lifecycle, true];
//         },
//         () => {
//           const lifecycle = new Lifecycle();
//           const factory = new ViewFactory('foo', noViewTemplate, lifecycle);
//           return [` noViewTemplate, viewFactory(cache=false)`, <View>factory.create(), noViewTemplate, factory, lifecycle, false];
//         },
//         () => {
//           const lifecycle = new Lifecycle();
//           const template = new MockTextNodeTemplate(expressions.text, new ObserverLocator(lifecycle, null, null, null)) as any;
//           const factory = new ViewFactory('foo', <any>template, lifecycle);
//           factory.setCacheSize('*', true);
//           return [`textNodeTemplate, viewFactory(cache=true )`, <View>factory.create(), template, factory, lifecycle, true];
//         },
//         () => {
//           const lifecycle = new Lifecycle();
//           const template = new MockTextNodeTemplate(expressions.text, new ObserverLocator(lifecycle, null, null, null)) as any;
//           const factory = new ViewFactory('foo', <any>template, lifecycle);
//           return [`textNodeTemplate, viewFactory(cache=false)`, <View>factory.create(), template, factory, lifecycle, false];
//         },
//         () => {
//           const lifecycle = new Lifecycle();
//           const template = new MockTextNodeTemplate(expressions.text, new ObserverLocator(lifecycle, null, null, null)) as any;
...
//           factory.setCacheSize('*', true);
//           return [`textNodeTemplate, viewFactory(cache=true )`, sut, template, factory, lifecycle, true];
//         },
//         () => {
//           const lifecycle = new Lifecycle();
//           const template = new MockTextNodeTemplate(expressions.text, new ObserverLocator(lifecycle, null, null, null)) as any;
...
//           addBindable(sut, child);
//           addAttachable(sut, child);
//           return [`textNodeTemplate, viewFactory(cache=false)`, sut, template, factory, lifecycle, false];
//         }
//       ],
//       [
...
//           expect(sut).to.have.$state.isBound();
//         }],
//         ([$11, $12, $13, $14, lifecycle], [$21, flags, scope]) => [`$bind+flush`, (sut) => {
//           sut.$bind(flags, scope);
...
//       ],
//       [
//         ([$11, $12, $13, $14, lifecycle]) => {
//           const encapsulationSource = document.createElement('div');
//           return [`Lifecycle(div, none)`, encapsulationSource, this.lifecycle.beginAttach(lifecycle, encapsulationSource, LifecycleFlags.none)]
//         }
//       ],
//       [
//         () => [`   noop`, PLATFORM.noop],
//         ([$11, $12, template, $14, lifecycle], $2, $3, [$41, location], $5, [$61, source, lifecycle]) => [`$attach`, (sut) => {
//           this.lifecycle.attach(sut).end();
...
//       ],
//       [
//         ([$11, $12, $13, $14, lifecycle]) => [`Lifecycle(none)`, new LifecycleController(lifecycle, LifecycleFlags.none)]
//       ],
//       [
//         () => [`   noop`, PLATFORM.noop],
//         ([$11, $12, template, factory, lifecycle, cache], $2, $3, [$41, location], $5, [$61, source], [$71, attach], [$81, release], [$91, lifecycle]) => [`$detach`, (sut) => {
//           this.lifecycle.detach(sut).end();
