...
//     this.lifecycle.processFlushQueue(LifecycleFlags.none)
...
//   const ifSut = new If(lifecycle, ifFactory, ifLoc);
...
//         this.lifecycle.beginAttach(lifecycle, host, LifecycleFlags.none).attach(ifSut).end();
...
//         this.lifecycle.beginDetach(lifecycle, LifecycleFlags.none).detach(ifSut).end();
...
//       ([,,]) => [(ifSut, elseSut, host, lifecycle) => {
//         this.lifecycle.beginDetach(lifecycle, LifecycleFlags.unbindAfterDetached).detach(ifSut).end();
