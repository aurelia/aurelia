(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./types", "./task"], factory);
    }
    ...
    class TaskQueue {
        ...
        queueTask(callback, opts) {
            const { delay, preempt, persistent, reusable } = { ...types_1.defaultQueueTaskOptions, ...opts };
            if (preempt) {
                if (delay > 0) {
            ...
            if (reusable) {
                ...
                if (index >= 0) {
                    ...
                    task = new task_1.Task(this, time, time + delay, preempt, persistent, reusable, callback);
                }
            }
            else {
                task = new task_1.Task(this, time, time + delay, preempt, persistent, reusable, callback);
