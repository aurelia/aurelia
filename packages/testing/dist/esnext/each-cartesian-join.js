export function eachCartesianJoinFactory(arrays, callback) {
...
export function eachCartesianJoin(arrays, callback) {
    arrays = arrays.slice(0).filter(arr => arr.length > 0);
    if (typeof callback !== 'function') {
        throw new Error('Callback is not a function');
    }
...
export async function eachCartesianJoinAsync(arrays, callback) {
    arrays = arrays.slice(0).filter(arr => arr.length > 0);
    if (typeof callback !== 'function') {
        throw new Error('Callback is not a function');
    }
