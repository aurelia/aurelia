System.register('testing', ['@aurelia/kernel', '@aurelia/debug', '@aurelia/runtime-html', '@aurelia/runtime', '@aurelia/jit'], function (exports, module) {
  'use strict';
  var PLATFORM, isNumeric, Tracer, Registration, IContainer, inject, DI, kebabCase, Profiler, Tracer$1, stringifyLifecycleFlags, Serializer, Unparser, DebugConfiguration, DOM, Compose, HTMLDOM, Replaceable, With, If, Repeat, INode, IDOM, CompiledTemplate, Binding, BindingMode, addBinding, IObserverLocator, instructionRenderer, RuntimeBasicConfiguration, IDOMInitializer, IProjectorLocator, ITargetAccessorLocator, ITargetObserverLocator, ITemplateFactory, Aurelia, ILifecycle, HydrateTemplateController, ToViewBindingInstruction, IteratorBindingInstruction, HydrateElementInstruction, LetElementInstruction, LetBindingInstruction, ITemplateCompiler, IRenderer, IRenderingEngine, valueConverter, bindable, customElement, ILifecycleRegistration, IDirtyChecker, IObserverLocatorRegistration, Scope, OverrideContext, parseExpression;
  return {
    setters: [function (module) {
      ...
      stringifyLifecycleFlags = module.stringifyLifecycleFlags;
      Serializer = module.Serializer;
      Unparser = module.Unparser;
      DebugConfiguration = module.DebugConfiguration;
    }, function (module) {
      DOM = module.DOM;
      ...
      ILifecycleRegistration = module.ILifecycleRegistration;
      IDirtyChecker = module.IDirtyChecker;
      IObserverLocatorRegistration = module.IObserverLocatorRegistration;
      Scope = module.Scope;
      OverrideContext = module.OverrideContext;
    }, function (module) {
      parseExpression = module.parseExpression;
    }],
    execute: function () {

      exports({
        _: _,
        createObserverLocator: createObserverLocator,
        createScopeForTest: createScopeForTest,
        createSpy: createSpy,
        disableTracing: disableTracing,
        eachCartesianJoin: eachCartesianJoin,
        eachCartesianJoinAsync: eachCartesianJoinAsync,
        eachCartesianJoinFactory: eachCartesianJoinFactory,
        enableTracing: enableTracing,
        getVisibleText: getVisibleText,
        h: h,
        htmlStringify: htmlStringify,
        inspect: inspect,
        jsonStringify: jsonStringify,
        padLeft: padLeft,
        padRight: padRight,
        recordCalls: recordCalls,
        stopRecordingCalls: stopRecordingCalls,
        stringify: stringify,
        targetedInstructionTypeName: targetedInstructionTypeName,
        verifyASTEqual: verifyASTEqual,
        verifyBindingInstructionsEqual: verifyBindingInstructionsEqual,
        verifyEqual: verifyEqual,
        writeProfilerReport: writeProfilerReport
      });
      ...
      const trimFull = exports('trimFull', (function () {
          const cache = {};
      ...
      const SymbolTraceWriter = exports('SymbolTraceWriter', {
          write(info) {
              let output = '(';
      ...
      const assert = exports('assert', Object_freeze({
          throws,
          doesNotThrow,
          rejects,
          doesNotReject,
      ...
      ***************************************************************************** */
      ...
      let AuTextRenderer = exports('AuTextRenderer', 
      /** @internal */
      ...
      AuTextRenderer = exports('AuTextRenderer', __decorate([
          inject(IObserverLocator),
          instructionRenderer('au')
          /** @internal */
      ], AuTextRenderer));
      const AuDOMConfiguration = exports('AuDOMConfiguration', {
          register(container) {
      ...
      const AuDOMTest = exports('AuDOMTest', {
          setup() {
       ...
       */
      const CSS_PROPERTIES = exports('CSS_PROPERTIES', {
          'align-content': {
              'values': [
                  'baseline',
                  'center',
      ...
      */
      const PSEUDO_ELEMENTS = exports('PSEUDO_ELEMENTS', [
          ':after',
          ':before',
          ':backdrop',
          ':cue',
      ...
      const globalAttributeNames = exports('globalAttributeNames', [
          'xml:lang',
          'xml:base',
          'accesskey',
          'autocapitalize',
       ...
       */
      const hJsx = exports('hJsx', function (name, attrs, ...children) {
      ...
      const TestContext = exports('TestContext', {
      ...
      SortValueConverter = exports('SortValueConverter', __decorate([
          valueConverter('sort')
      ], SortValueConverter));
      ...
      JsonValueConverter = exports('JsonValueConverter', __decorate([
          valueConverter('json')
      ], JsonValueConverter));
      ...
      const TestConfiguration = exports('TestConfiguration', {
          register(container) {
