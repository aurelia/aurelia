...
export function areSimilarRegExps(a, b) {
    return a.source === b.source && a.flags === b.flags;
}
export function areSimilarFloatArrays(a, b) {
...
export function areSimilarTypedArrays(a, b) {
    if (a.byteLength !== b.byteLength) {
        return false;
    }
    return compare(new Uint8Array(a.buffer, a.byteOffset, a.byteLength), new Uint8Array(b.buffer, b.byteOffset, b.byteLength)) === 0;
}
export function areEqualArrayBuffers(buf1, buf2) {
    return (buf1.byteLength === buf2.byteLength
        && compare(new Uint8Array(buf1), new Uint8Array(buf2)) === 0);
}
export function isEqualBoxedPrimitive(val1, val2) {
...
export function innerDeepEqual(val1, val2, strict, memos) {
    if (val1 === val2) {
        if (val1 !== 0) {
            return true;
        }
...
export function keyCheck(val1, val2, strict, memos, iterationType, aKeys) {
...
export function setHasEqualElement(set, val1, strict, memos) {
...
export function findLooseMatchingPrimitives(val) {
    switch (typeof val) {
        case 'undefined':
            return null;
        case 'object':
...
export function setMightHaveLoosePrimitive(a, b, val) {
...
export function mapMightHaveLoosePrimitive(a, b, val, item, memos) {
    const altValue = findLooseMatchingPrimitives(val);
    if (altValue != null) {
        return altValue;
    }
...
export function setEquiv(a, b, strict, memos) {
    let set = null;
    for (const val of a) {
        if (isObject(val)) {
            if (set === null) {
...
export function mapHasEqualEntry(set, map, key1, item1, strict, memos) {
...
export function mapEquiv(a, b, strict, memos) {
    let set = null;
...
export function objEquiv(a, b, strict, keys, memos, iterationType) {
    let i = 0;
