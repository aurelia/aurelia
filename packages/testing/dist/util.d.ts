...
export declare type BoxedPrimitive = Number | Boolean | String | BigInt | Symbol;
...
export declare type TypedArray = IntArray | FloatArray | BigIntArray;
...
export declare type TypedArrayConstructor = IntArrayConstructor | FloatArrayConstructor | BigIntArrayConstructor;
...
export declare const Object_keys: (o: {}) => string[];
...
export declare const BigInt_valueOf: (thisArg: unknown) => bigint;
...
export declare function isBigIntObject(arg: unknown): arg is BigInt;
