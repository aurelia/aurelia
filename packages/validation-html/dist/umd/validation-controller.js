...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@aurelia/kernel", "@aurelia/runtime", "@aurelia/validation", "@aurelia/runtime-html"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ValidationControllerFactory = exports.ValidationController = exports.IValidationController = exports.getPropertyInfo = exports.BindingInfo = exports.ValidationEvent = exports.ValidationResultTarget = exports.ControllerValidateResult = exports.ValidateEventKind = void 0;
    ...
    })(ValidateEventKind = exports.ValidateEventKind || (exports.ValidateEventKind = {}));
    /**
    ...
    let ValidationController = class ValidationController {
        ...
        addError(message, object, propertyName) {
            ...
            if (propertyName !== void 0) {
                [resolvedPropertyName] = validation_1.parsePropertyName(propertyName, this.parser);
            }
            const result = new validation_1.ValidationResult(false, message, resolvedPropertyName, object, undefined, undefined, true);
            ...
            if (obj !== void 0) {
                ...
                instructions = [
                    ...Array.from(this.objects.entries())
                        .map(([object, rules]) => new validation_1.ValidateInstruction(object, void 0, rules, objectTag)),
                    ...(!objectTag ? Array.from(this.bindings.entries()) : [])
                        ...
                        if (propertyInfo !== void 0 && !this.objects.has(propertyInfo.object)) {
                            acc.push(new validation_1.ValidateInstruction(propertyInfo.object, propertyInfo.propertyName, info.rules));
                        }
                        return acc;
                    }, [])
                ];
        ...
        async validateBinding(binding) {
            ...
            await this.validate(new validation_1.ValidateInstruction(object, propertyName, rules));
        }
        resetBinding(binding) {
            ...
            const { object, propertyName } = propertyInfo;
            this.reset(new validation_1.ValidateInstruction(object, propertyName));
        }
    ...
    class ValidationControllerFactory {
        ...
        construct(container, _dynamicDependencies) {
            return _dynamicDependencies !== void 0
                ...
                : new ValidationController(container.get(validation_1.IValidator), container.get(runtime_1.IExpressionParser), container.get(runtime_html_1.IPlatform), container);
        }
    }
