...
import { Scope as l, IExpressionParser as c, PrimitiveLiteralExpression as h } from "../../../runtime/dist/native-modules/index.js";
...
let A = class ValidationMessageProvider {
    ...
    parseMessage(e) {
        const t = this.parser.parse(e, 2048);
