(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@aurelia/kernel", "@aurelia/runtime", "./rule-provider", "./validator"], factory);
    }
    ...
    let ValidationController = class ValidationController {
        ...
        addError(message, object, propertyName) {
            ...
            if (propertyName !== void 0) {
                [resolvedPropertyName] = rule_provider_1.parsePropertyName(propertyName, this.parser);
            }
            const result = new rule_provider_1.ValidationResult(false, message, resolvedPropertyName, object, undefined, undefined, true);
        ...
        async validate(instruction) {
            ...
            let instructions;
            if (obj !== void 0) {
                instructions = [new validator_1.ValidateInstruction(obj, instruction.propertyName, (_a = instruction.rules, (_a !== null && _a !== void 0 ? _a : this.objects.get(obj))), objectTag, instruction.propertyTag)];
            }
            else {
                // validate all objects and bindings.
                instructions = [
                    ...Array.from(this.objects.entries())
                        .map(([object, rules]) => new validator_1.ValidateInstruction(object, void 0, rules, objectTag)),
                    ...(!objectTag ? Array.from(this.bindings.entries()) : [])
                        ...
                        if (propertyInfo !== void 0 && !this.objects.has(propertyInfo.object)) {
                            acc.push(new validator_1.ValidateInstruction(propertyInfo.object, propertyInfo.propertyName, info.rules));
                        }
                        return acc;
                    }, [])
                ];
        ...
        async validateBinding(binding) {
            ...
            await this.validate(new validator_1.ValidateInstruction(object, propertyName, rules));
        }
        resetBinding(binding) {
            ...
            const { object, propertyName } = propertyInfo;
            this.reset(new validator_1.ValidateInstruction(object, propertyName));
        }
        async revalidateErrors() {
            ...
            for (const [object, innerMap] of map) {
                promises.push(this.validate(new validator_1.ValidateInstruction(object, undefined, Array.from(innerMap)
                    .map(([{ validationRules, messageProvider, property }, rules]) => new rule_provider_1.PropertyRule(validationRules, messageProvider, property, [rules])))));
            }
    ...
    ValidationController = tslib_1.__decorate([
        tslib_1.__param(0, validator_1.IValidator),
    ...
    class ValidationControllerFactory {
        ...
        construct(container, _dynamicDependencies) {
            return _dynamicDependencies !== void 0
                ...
                : new ValidationController(container.get(validator_1.IValidator), container.get(runtime_1.IExpressionParser), container.get(runtime_1.IScheduler));
        }
    }
