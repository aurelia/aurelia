(function (factory) {
    ...
    let ValidationController = class ValidationController {
        ...
        async validate(instruction) {
            ...
            let instructions;
            if (obj !== void 0) {
                instructions = [new validator_1.ValidateInstruction(obj, instruction.propertyName, (_a = instruction.rules) !== null && _a !== void 0 ? _a : this.objects.get(obj), objectTag, instruction.propertyTag)];
            }
            else {
