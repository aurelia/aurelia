...
import { BindingBehaviorExpression, IExpressionParser, IScope, IScheduler, PropertyBinding } from '@aurelia/runtime';
import { PropertyAccessor, PropertyRule, ValidationResult } from './rule-provider';
