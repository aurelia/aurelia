...
define('runtime/di',["require", "exports", "./platform", "./reporter"], function (require, exports, platform_1, reporter_1) {
    ...
    var ConstructionHandler = (function () {
        function ConstructionHandler(fn, invoker, dependencies) {
            this.fn = fn;
            this.invoker = invoker;
            this.dependencies = dependencies;
            this.transformers = null;
        }
        ConstructionHandler.prototype.construct = function (container, dynamicDependencies) {
        ...
        ConstructionHandler.prototype.registerTransformer = function (transformer) {
        ...
        ConstructionHandler.create = function (fn) {
    ...
    var Container = (function () {
        ...
        Container.prototype.registerTransformer = function (key, transformer) {
            ...
            if (resolver.getConstructionHandler) {
                var handler = resolver.getConstructionHandler(this);
                if (handler === null) {
                    return false;
                }
        ...
        Container.prototype.getConstructionHandler = function (type) {
...
define('runtime/binding/ast',["require", "exports", "./binding-context", "./signaler", "./binding-flags"], function (require, exports, binding_context_1, signaler_1, binding_flags_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('runtime/binding/binding',["require", "exports", "./binding-mode", "./connectable-binding", "./connect-queue", "./binding-context", "../reporter", "./binding-flags"], function (require, exports, binding_mode_1, connectable_binding_1, connect_queue_1, binding_context_1, reporter_1, binding_flags_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('runtime/resources/else',["require", "exports", "./if-core", "../templating/visual", "../templating/render-slot", "../decorators", "../di"], function (require, exports, if_core_1, visual_1, render_slot_1, decorators_1, di_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('runtime/resources/if',["require", "exports", "./if-core", "../templating/render-slot", "../decorators", "../di", "../templating/visual"], function (require, exports, if_core_1, render_slot_1, decorators_1, di_1, visual_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('runtime/resources/replaceable',["require", "exports", "../decorators", "../templating/render-slot", "../di", "../templating/visual"], function (require, exports, decorators_1, render_slot_1, di_1, visual_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('runtime/resources/with',["require", "exports", "../decorators", "../templating/render-slot", "../binding/binding-context", "../di", "../templating/visual"], function (require, exports, decorators_1, render_slot_1, binding_context_1, di_1, visual_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var With = (function () {
...
define('runtime/templating/component',["require", "exports", "./view", "./shadow-dom", "../platform", "../di", "../binding/binding-mode", "../binding/binding-context", "./lifecycle", "../dom"], function (require, exports, view_1, shadow_dom_1, platform_1, di_1, binding_mode_1, binding_context_1, lifecycle_1, dom_1) {
    ...
    exports.Component = {
        valueConverter: function (nameOrSource, ctor) {
            var definition = createDefinition(nameOrSource);
            var Type = ctor;
            Type.definition = definition;
            Type.register = function (container) {
                container.register(di_1.Registration.singleton(definition.name, Type));
            };
            return Type;
        },
        ...
        attribute: function (nameOrSource, ctor) {
            var definition = createAttributeDefinition(nameOrSource);
            var Type = ctor;
            var proto = Type.prototype;
            var observables = Type.observables || {};
            Type.definition = definition;
            Type.register = function register(container) {
                container.register(di_1.Registration.transient(definition.name, Type));
                var aliases = definition.aliases;
                for (var i = 0, ii = aliases.length; i < ii; ++i) {
                    container.register(di_1.Registration.alias(definition.name, aliases[i]));
                }
            };
        ...
        element: function (nameOrSource, ctor) {
            ...
            var definition = createTemplateDefinition(typeof nameOrSource === 'string' ? { name: nameOrSource } : nameOrSource, Type);
            var proto = Type.prototype;
            Type.definition = definition;
            Type.register = function (container) {
                container.register(di_1.Registration.transient(definition.name, Type));
            ...
            proto.$hydrate = function (renderingEngine, host, options) {
                ...
                var template = renderingEngine.getElementTemplate(definition, Type);
                this.$bindable = [];
                this.$attachable = [];
                this.$changeCallbacks = [];
                ...
                this.$host = definition.containerless ? dom_1.DOM.convertToAnchor(host, true) : host;
                this.$shadowRoot = dom_1.DOM.createElementViewHost(this.$host, definition.shadowOptions);
...
define('runtime/templating/render-slot',["require", "exports", "./shadow-dom", "./lifecycle", "../di", "./visual"], function (require, exports, shadow_dom_1, lifecycle_1, di_1, visual_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            var ComponentVisual = (function (_super) {
                ...
                ComponentVisual.prototype.createView = function () {
                    ...
                    if (typeof componentOrType === 'function') {
                        ...
                        target = componentOrType.element || dom_1.DOM.createElement(componentType.definition.name);
...
define('runtime/templating/visual',["require", "exports", "../di"], function (require, exports, di_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var MotionDirection;
