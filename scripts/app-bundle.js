...
define('app',["require", "exports", "./framework/property-observation", "./framework"], function (require, exports, property_observation_1, framework_1) {
    ...
    var NameTag = (function (_super) {
        ...
        NameTag.prototype.hydrate = function (element) {
            ...
            this.$b6 = framework_1.twoWay('nameTagBorderWidth', elements[4], 'value');
            this.$b7 = framework_1.twoWay('nameTagHeaderVisible', elements[5], 'checked');
            this.$b8 = new framework_1.Listener(this.$scope, 'click', elements[6], 'click', null);
            this.$b9 = framework_1.oneWay('nameTagBorder', element.style, 'border');
            this.$b10 = framework_1.oneWay('nameTagClasses', element, 'className');
            return this;
        };
...
define('framework',["require", "exports", "./core", "./framework/ast", "./framework/binding", "../scripts/app-bundle"], function (require, exports, core_1, ast_1, binding_1, app_bundle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var emptyArray = [];
    function getTargets(element) {
    ...
    function oneWay(sourceExpression, target, targetProperty) {
        return new binding_1.Binding(getAST(sourceExpression), target, targetProperty, app_bundle_1.bindingMode.oneWay, null);
    }
    exports.oneWay = oneWay;
    function twoWay(sourceExpression, target, targetProperty) {
        return new binding_1.Binding(getAST(sourceExpression), target, targetProperty, app_bundle_1.bindingMode.twoWay, null);
    }
    exports.twoWay = twoWay;
