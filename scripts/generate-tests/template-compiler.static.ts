import { Statement, PropertyDeclaration } from 'typescript';
import {
  emit,
  $property,
  $$import,
...
function $$test(markup: string, expectedText: string, properties: PropertyDeclaration[], ids: Identifiable[], resources: Statement[]) {
  const test = $$functionExpr('it', [
