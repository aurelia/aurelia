...
var Asts = {
    ...
    2: new AccessScope("color", 0),
    3: new AccessScope("name", 0),
    4: new AccessScope("borderColor", 0),
    5: new AccessScope("borderWidth", 0),
    6: new AccessScope("showHeader", 0),
    7: new CallScope("submit", 0),
    8: new AccessScope("computedName", 0)
};
